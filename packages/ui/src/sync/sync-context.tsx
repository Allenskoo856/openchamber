      ...
      void Promise.resolve()
        .then(() => {
          ...
          for (const [directory, store] of childStores.children.entries()) {
            ...
            // Defensive: OpenCode can leave tool parts `running` after idle/timeout
            // without a final message.part.updated. Settle orphans so shell/task UI
            // cannot wait forever on a missed settle event.
