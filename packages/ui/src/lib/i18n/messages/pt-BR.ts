...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.session.engine.claudeCodeAria": "Mecanismo Claude Code",
  "sessions.sidebar.session.engine.claudeCodeTooltip": "Em execução no Claude Code",
  ...
  "gitView.pr.comments.addAll": "Adicionar tudo ao chat",
  ...
  "chat.modelControls.cacheRead": "Leitura de cache",
  "chat.modelControls.cacheWrite": "Escrita de cache",
  "chat.modelControls.costInOutShort": "Ent. {input} · Saída {output}",
  "chat.modelControls.modalityInputAria": "{modality} de entrada",
  "chat.modelControls.modalityOutputAria": "{modality} de saída",
  ...
  "chat.engines.section": "Mecanismos",
  ...
  "chat.engines.permissionMode.acceptEdits": "Aceitar edições",
  "chat.engines.permissionMode.plan": "Plano",
  "chat.engines.permissionMode.dontAsk": "Não perguntar",
  "chat.engines.permissionMode.aria": "Modo de permissão: {mode}",
  "chat.engines.permissionMode.tooltip": "Modo de permissão: {mode}",
  "chat.engines.effort.label": "Esforço",
  "chat.engines.effort.default": "Padrão",
  "chat.engines.effort.low": "Baixo",
  "chat.engines.effort.medium": "Médio",
  "chat.engines.effort.high": "Alto",
  "chat.engines.effort.xhigh": "Muito alto",
  "chat.engines.effort.max": "Máximo",
  "chat.engines.effort.aria": "Esforço: {level}",
  "chat.engines.effort.tooltip": "Esforço: {level}",
  "chat.engines.capability.goalUnsupported": "Metas estão disponíveis apenas no OpenCode. Alterne esta sessão para OpenCode para usar metas.",
  "chat.engines.capability.multirunUnsupported": "MultiRun está disponível apenas no OpenCode. Alterne esta sessão para OpenCode para iniciar um MultiRun.",
  "chat.handoff.billingDialog.title": "Continuar no Claude Code?",
  "chat.handoff.billingDialog.body": "Isso inicia uma nova sessão no Claude Code usando os limites de uso da sua assinatura Claude. Os provedores de API do OpenCode permanecem inalterados. O texto da conversa é copiado como contexto; a sessão original permanece intacta.",
  "chat.handoff.billingDialog.continue": "Continuar",
  "chat.handoff.billingDialog.cancel": "Cancelar",
  "chat.handoff.billingDialog.dontShowAgain": "Não mostrar novamente",
  "chat.handoff.billingDialog.dontShowAgainAria": "Não mostrar novamente este aviso de cobrança na transferência",
