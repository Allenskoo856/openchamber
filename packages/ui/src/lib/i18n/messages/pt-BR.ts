...
export const dict: Record<I18nKey, string> = {
  ...
  "session.workspaceBadge.fallback": "Espaço isolado",
  "session.workspaceBadge.hint": "Este chat roda em um espaço isolado no {runtime}. Seus arquivos mudam só depois de revisar e aplicar.",
