...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.mcp.page.actions.showTools': '显示工具',
  'settings.mcp.page.actions.loadingTools': '正在加载工具...',
  'settings.mcp.page.actions.refreshTools': '刷新',
  'settings.mcp.page.toolsDialog.title': 'MCP 工具',
  'settings.mcp.page.toolsDialog.description': '此 MCP 服务器当前公开的工具。',
  ...
  'settings.mcp.page.toast.listToolsFailed': '无法列出 MCP 工具',
