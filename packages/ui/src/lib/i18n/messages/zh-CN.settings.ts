export const settingsDict = {
  ...
  'settings.page.workspaces.title': '工作区',
  'settings.workspaces.title': '安全工作区',
  'settings.workspaces.allowedImages': '精确镜像允许列表',
  'settings.workspaces.allowedImagesHint': '用逗号分隔按摘要固定的镜像。留空时仅允许所选运行时镜像。',
  'settings.workspaces.docker.memory': 'Docker 内存限制',
  'settings.workspaces.docker.cpu': 'Docker CPU 限制',
  'settings.workspaces.docker.pids': 'Docker PID 限制',
  'settings.workspaces.apple.memory': 'Apple Container 内存限制',
  'settings.workspaces.apple.cpu': 'Apple Container CPU 限制',
  'settings.workspaces.kubernetes.storage': '存储',
  'settings.workspaces.kubernetes.cpuRequest': 'CPU 请求',
  'settings.workspaces.kubernetes.memoryRequest': '内存请求',
  'settings.workspaces.kubernetes.cpuLimit': 'CPU 限制',
  'settings.workspaces.kubernetes.memoryLimit': '内存限制',
  'settings.workspaces.kubernetes.connectivity': '连接方式',
  'settings.workspaces.kubernetes.portForward': '端口转发',
  'settings.workspaces.kubernetes.ingress': '入口',
  'settings.workspaces.kubernetes.ingressClass': '入口类',
  'settings.workspaces.kubernetes.hostTemplate': 'HTTPS 主机模板',
  'settings.workspaces.kubernetes.pathTemplate': '路径模板',
  'settings.workspaces.kubernetes.namespaceSelector': '控制器命名空间选择器 (JSON)',
  'settings.workspaces.kubernetes.podSelector': '控制器 Pod 选择器 (JSON)',
  'settings.workspaces.kubernetes.annotations': '允许的注解 (JSON)',
  'settings.workspaces.kubernetes.tlsMode': 'TLS 证书',
  'settings.workspaces.kubernetes.existingSecret': '现有密钥',
  'settings.workspaces.kubernetes.certManager': '证书管理器',
  'settings.workspaces.kubernetes.tlsSecret': 'TLS 密钥名称',
  'settings.workspaces.kubernetes.clusterIssuer': '集群颁发者',
  'settings.workspaces.egress.mode': '出站模式',
  'settings.workspaces.egress.managed': '托管',
  'settings.workspaces.egress.external': '外部代理',
  'settings.workspaces.egress.gatewayImage': '网关镜像摘要',
  'settings.workspaces.egress.preset': '托管预设',
  'settings.workspaces.egress.restricted': '受限',
  'settings.workspaces.egress.custom': '自定义',
  'settings.workspaces.egress.allowedDomains': '允许的域名',
  'settings.workspaces.egress.allowedCIDRs': '允许的 CIDR',
  'settings.workspaces.egress.allowedPorts': '允许的端口',
  'settings.workspaces.policy.title': '凭据与保留',
  'settings.workspaces.credentials.modelAuth': '模型身份验证授权',
  'settings.workspaces.credentials.modelAuthHint': '凭据仅在明确授权后存入提供方文件，绝不会自动继承。',
  'settings.workspaces.credentials.none': '不授权',
  'settings.workspaces.credentials.explicit': '授权 OpenCode 身份验证',
  'settings.workspaces.retention.preserve': '删除时保留存储',
  'settings.workspaces.retention.warning': '警告：提供方存储将保留，需要管理员另行清理。',
  'settings.workspaces.lifecycle.reconcile': '协调',
  'settings.workspaces.lifecycle.reconnect': "尝试重新连接",
  'settings.workspaces.lifecycle.reconciled': '工作区协调已完成。',
  ...
  'settings.workspaces.export.downloadFailed': '无法下载工作区制品。',
  'settings.workspaces.export.discardFailed': '无法丢弃工作区制品。',
  'settings.workspaces.description': '在隔离的 Docker 或 Kubernetes 运行时中运行 OpenCode 会话，并显式导出变更。',
  'settings.workspaces.reauth.prompt': '请使用 OpenChamber 密码确认此特权工作区操作。',
  'settings.workspaces.reauth.title': '确认工作区操作',
  'settings.workspaces.reauth.confirm': '确认',
  'settings.workspaces.reauth.failed': '无法确认此特权工作区操作。',
  'settings.workspaces.reauth.windowHint': '确认后，相关特权操作在几分钟内不会再次要求输入密码。',
  'settings.workspaces.newSession.notConfigured': 'Secure Workspaces 尚未设置。请先在设置中配置并激活。',
  'settings.workspaces.actions.close': '返回聊天',
  'settings.workspaces.setup.done': "完成",
  'settings.workspaces.safety.filesLabel': "您的项目文件",
  'settings.workspaces.safety.filesValue': "在您应用之前保持不变",
  'settings.workspaces.safety.internetLabel': "网络访问",
  'settings.workspaces.safety.internetValueRestricted': "受限",
  'settings.workspaces.safety.internetValueProxy': "通过您的代理",
  'settings.workspaces.advanced.hide': "隐藏高级设置",
  'settings.workspaces.advanced.credentialsGroup': "模型凭据",
  'settings.workspaces.advanced.imagesGroup': "容器镜像",
  'settings.workspaces.advanced.limitsGroup': "资源限制",
  'settings.workspaces.advanced.limitsHint': "应用于每个工作区的上限。留空表示使用提供程序默认值。",
  'settings.workspaces.advanced.networkGroup': "网络访问",
  'settings.workspaces.advanced.clusterGroup': "集群连接",
  'settings.workspaces.advanced.clusterHint': "OpenChamber 如何连接到您的 Kubernetes 集群及其中的工作区。",
  'settings.workspaces.credentials.explicitHint': "助手可以在工作区内使用您的模型。",
  'settings.workspaces.credentials.noneHint': "助手无法在工作区内回答。",
  'settings.workspaces.setup.readyTitle': "可以使用",
  'settings.workspaces.setup.readyHint': "新建会话并选择 Secure Workspace，即可在项目的隔离副本中工作。",
  'settings.workspaces.setup.notReadyTitle': "需要设置",
  'settings.workspaces.setup.notReadyHint': "完成下列步骤，即可在隔离环境中运行会话。",
  'settings.workspaces.setup.title': "设置状态",
  'settings.workspaces.setup.stepRuntime': "容器运行时可用",
  'settings.workspaces.setup.pathTitle': "准备 {provider}",
  'settings.workspaces.setup.pathHint': "按顺序完成。每一项都会自动检查，应用会自行完成力所能及的步骤。",
  'settings.workspaces.setup.pathReadyTitle': "{provider} 已就绪",
  'settings.workspaces.setup.pathReadyHint': "所有条件均已满足。列表保留，便于一眼确认。",
  'settings.workspaces.setup.working': "进行中…",
  'settings.workspaces.setup.action.create-namespace': "创建",
  'settings.workspaces.setup.action.check-isolation': "立即检查",
  'settings.workspaces.setup.namespaceCreated': "已创建命名空间。",
  'settings.workspaces.setup.namespaceExists': "该命名空间已存在。",
  'settings.workspaces.setup.isolationEnforced': "您的集群会强制执行网络隔离，工作区将被真正隔离。",
  'settings.workspaces.setup.isolationMissing': "该集群接受网络规则但不强制执行，工作区不会被隔离。请申请带 Calico 或 Cilium 的集群，或改用 Docker。",
  ...
  'settings.workspaces.setup.step.kubernetes.cluster': "集群连接",
  'settings.workspaces.setup.step.kubernetes.namespace': "命名空间",
  'settings.workspaces.setup.step.kubernetes.permissions': "权限",
  'settings.workspaces.setup.step.kubernetes.isolation': "网络隔离",
  'settings.workspaces.setup.step.apple-container.platform': "受支持的系统",
  'settings.workspaces.setup.step.apple-container.cli': "已安装 Apple Container",
  'settings.workspaces.setup.stepInfo.docker.cli': "Docker 提供每个隔离工作区运行所在的容器。",
  'settings.workspaces.setup.stepInfo.docker.daemon': "启动工作区前 Docker 引擎必须正在运行。",
  'settings.workspaces.setup.stepInfo.kubernetes.cli': "kubectl 是应用与集群通信所用的工具。",
  'settings.workspaces.setup.stepInfo.kubernetes.cluster': "选择这台电脑已能访问的集群，其命名空间会一并带入。",
  'settings.workspaces.setup.stepInfo.kubernetes.namespace': "工作区拥有独立的命名空间，不与集群其余部分混杂。",
  'settings.workspaces.setup.stepInfo.kubernetes.permissions': "您的账号需有权在该命名空间创建工作区资源。",
  'settings.workspaces.setup.stepInfo.kubernetes.isolation': "集群可能接受网络规则却不执行。此检查证明您的集群确实执行。",
  'settings.workspaces.setup.stepInfo.apple-container.platform': "Apple Container 工作区仅在 macOS 上运行。",
  'settings.workspaces.setup.stepInfo.apple-container.cli': "Apple Container 命令行工具提供隔离容器。",
  'settings.workspaces.setup.stepEnable': "已启用 Secure Workspaces",
  'settings.workspaces.setup.stepEnableHint': "已关闭 — 会话仍直接在您的计算机上运行。",
  'settings.workspaces.setup.stepActivate': "可以创建工作区",
  'settings.workspaces.setup.stepActivateHint': "激活以加载工作区运行时。",
  'settings.workspaces.setup.turnOn': "启用",
  'settings.workspaces.setup.recheck': "重新检查",
  'settings.workspaces.setup.checking': "检查中…",
  'settings.workspaces.where.title': "工作区运行位置",
  'settings.workspaces.where.description': "选择承载隔离工作区的运行时。可用性会自动检查。",
  'settings.workspaces.where.dockerRecommended': "在自己的电脑上，Docker 是正确选择：隔离同样严格，启动更快，除 Docker 本身外无需任何配置。",
  'settings.workspaces.where.kubernetesWhen': "当工作需要在这台电脑之外运行时选择 Kubernetes——公司提供的集群、更大的机器或带 GPU 的机器。运行在本机的集群并不比 Docker 更有优势。",
  'settings.workspaces.safety.title': "工作区能做什么",
  'settings.workspaces.safety.description': "适用于您创建的每个工作区的隔离规则。",
  'settings.workspaces.safety.filesText': "您的文件不会被改动：工作区使用自己的副本，在您检查并应用更改之前，任何内容都不会进入您的项目。",
  'settings.workspaces.safety.internetRestricted': "网络访问仅限于您的模型提供商、软件包仓库以及您在下面添加的域名。",
  'settings.workspaces.safety.internetProxy': "网络访问通过“高级”中配置的外部代理进行。",
  'settings.workspaces.safety.credentialsHint': "工作区是否获得您的模型凭据副本。没有凭据，助手无法在工作区内回答。",
  'settings.workspaces.advanced.title': "高级",
  'settings.workspaces.advanced.description': "基础设施细节。默认值是经过认证的 — 确有需要时再更改。",
  'settings.workspaces.advanced.reveal': "显示高级设置",
  'settings.workspaces.advanced.imagesHint': "容器镜像按摘要固定。留空则使用已签名的发布镜像。",
  'settings.workspaces.advanced.customImages': "正在使用自定义镜像",
  'settings.workspaces.advanced.customImagesHint': "运行工作区的一切都必须能访问它们。清空这些字段可恢复 OpenChamber 自带的镜像。",
  'settings.workspaces.advanced.useBuiltInImages': "使用自带镜像",
  'settings.workspaces.setup.imageUnpullable': "集群无法下载工作区镜像。由于什么都没能启动，未检查隔离。请检查“高级”中的镜像设置——仅本机可访问的镜像仓库对集群无效。",
  'settings.workspaces.advanced.egressHint': "工作区的出站网络规则。",
  'settings.workspaces.advanced.domainsHint': "额外域名，以逗号分隔。您的模型提供商会被自动允许。",
  'settings.workspaces.export.alreadyApplied': "已存在于您的文件中",
  'settings.workspaces.export.hostChanged': "您的文件已更改 — 请在应用前检查",
  'settings.workspaces.lifecycle.advanced': '高级操作',
  'settings.workspaces.lifecycle.connectHint': '工作区尚未连接。请稍等片刻，或运行“修复”以重新连接。',
  'settings.workspaces.lifecycle.chooseProject': '选择一个项目以管理其 Secure Workspaces。',
  'settings.workspaces.lifecycle.createWith': "创建 {provider} 工作区",
  'settings.workspaces.progress.creating': "正在创建工作区，可能需要一分钟…",
  'settings.workspaces.progress.deleting': "正在删除工作区及其容器…",
  'settings.workspaces.progress.repairing': "正在修复工作区…",
  'settings.workspaces.progress.exporting': "正在收集待审查的更改…",
  'settings.workspaces.progress.checking': "正在将更改与您的文件比对…",
  'settings.workspaces.progress.applying': "正在将更改应用到您的文件…",
  'settings.workspaces.lifecycle.noProject': "未选择项目",
  'settings.workspaces.lifecycle.emptyHint': 'Secure Workspace 在隔离容器中运行您的项目：在您审核并应用更改之前，AI 不会触碰您的文件。',
  'settings.workspaces.errors.policyMismatch': '此工作区是使用旧的安全策略创建的，因此其操作已被禁用。请删除它并创建新的工作区以继续——删除功能仍然可用。',
  'settings.workspaces.lifecycle.drifted': "旧设置",
  'settings.workspaces.lifecycle.driftedHint': "创建于当前设置之前。它仍可运行和删除，但在重新创建前无法导出其更改。",
  'settings.workspaces.remediation.policyIncomplete': "此提供程序还需要更多配置。请打开下方的“高级”完成设置。",
  'settings.workspaces.remediation.docker.cliMissing': '未安装 Docker 或其不在 PATH 中。请安装并启动 Docker Desktop，然后重新验证。',
  'settings.workspaces.remediation.docker.daemonUnavailable': 'Docker 已安装但无响应。请启动 Docker Desktop 后重新验证。',
  'settings.workspaces.remediation.kubernetes.cliMissing': '未安装 kubectl 或其不在 PATH 中。请安装 kubectl 后重新验证。',
  'settings.workspaces.remediation.kubernetes.notConfigured': "未连接 Kubernetes 集群。请在 Docker Desktop 中启用 Kubernetes，或将 kubectl 指向现有集群，然后重新检查。",
  'settings.workspaces.remediation.kubernetes.clusterUnreachable': 'kubectl 无法连接到配置的集群。请检查 kubeconfig、上下文和集群可用性。',
  'settings.workspaces.remediation.kubernetes.namespaceMissing': '配置的命名空间在集群中不存在。请创建它或选择其他命名空间。',
  'settings.workspaces.remediation.apple.cliMissing': '未安装 Apple Container CLI。请安装 Apple Container 后重新验证。',
  'settings.workspaces.remediation.apple.daemonUnavailable': 'Apple Container 已安装，但其系统服务未运行。请启动后重新验证。',
  ...
  'settings.workspaces.reauth.op.configure': '更改 Secure Workspaces 设置',
  'settings.workspaces.reauth.op.validate': '检查提供程序',
  'settings.workspaces.reauth.op.setup': "完成一个设置步骤",
  'settings.workspaces.reauth.op.reconcile': '修复工作区',
  'settings.workspaces.reauth.op.export': '导出更改以供审查',
  'settings.workspaces.reauth.op.hostApply': '将审查过的更改应用到您的文件',
  'settings.workspaces.reauth.op.hostCapabilities': '更改设备权限',
  'settings.workspaces.newSession.groupLabel': "助手在哪里工作？",
  'settings.workspaces.newSession.host': "我的电脑",
  'settings.workspaces.newSession.secureHint': "助手在容器中处理项目副本。只有在您检查并应用后，文件才会更改。",
  'settings.workspaces.newSession.secureHintWithRuntime': "将在 {runtime} 中运行。助手处理项目副本；只有在您检查并应用后，文件才会更改。",
  'settings.workspaces.newSession.secure': "隔离工作区",
  'settings.workspaces.newSession.chooseProject': '使用安全工作区前请选择项目。',
  'settings.workspaces.newSession.progress': '{phase}',
  'settings.workspaces.newSession.partial': '工作区会话已部分创建。请重试以恢复它，避免创建重复会话。',
  'settings.workspaces.newSession.phasePreparing': '正在准备安全工作区…',
  'settings.workspaces.newSession.phaseConnecting': '正在连接安全工作区…',
  'settings.workspaces.newSession.phaseCreating': '正在创建安全会话…',
  'settings.workspaces.newSession.phaseOpening': '正在打开安全会话…',
  'settings.workspaces.newSession.retry': '安全重试',
  'settings.workspaces.newSession.startFailed': "无法启动隔离工作区。请在设置中检查配置后重试。",
  'settings.workspaces.enable': '启用安全工作区',
  'settings.workspaces.enableHint': '允许创建隔离运行时，以更安全地执行代理。',
  'settings.workspaces.image': '运行时镜像',
  'settings.workspaces.requirePinnedImage': '要求固定的镜像标签或 digest',
  ...
  'settings.workspaces.actions.validating': '正在检查...',
  'settings.workspaces.status.available': '可用',
  'settings.workspaces.status.unavailable': '不可用',
  'settings.workspaces.status.unsupported': '此运行时不支持管理 workspace provider。',
  'settings.workspaces.status.notChecked': '未检查',
  'settings.workspaces.compatibility.title': 'OpenCode workspace 支持',
  'settings.workspaces.compatibility.active': '安全 workspace provider 已在正在运行的 OpenCode 服务器中配置并激活。',
  'settings.workspaces.compatibility.configuredInactive': '安全 workspace provider 已配置，但尚未激活。创建 workspace 前请先激活。',
  'settings.workspaces.compatibility.notConfigured': '安全 workspace provider 尚未配置。',
  'settings.workspaces.compatibility.unsupported': '正在运行的 OpenCode 服务器未提供 experimental workspace API。安装 plugin 后请更新或重启 OpenCode。',
  'settings.workspaces.compatibility.activate': '激活 provider',
  'settings.workspaces.compatibility.recheck': '重新检查',
  'settings.workspaces.compatibility.activated': 'Workspace provider 已激活。',
  'settings.workspaces.compatibility.pending': 'Workspace provider 已配置。请在 OpenCode 加载完成后重新检查。',
  'settings.workspaces.compatibility.manualRestart': '外部 OpenCode 已配置，但 OpenChamber 无法重启它。请重启该 OpenCode 服务器后重新检查。',
  'settings.workspaces.compatibility.failed': '无法检查 workspace 支持。',
  'settings.workspaces.kubernetes.context': 'Kubernetes 上下文',
  'settings.workspaces.kubernetes.namespace': 'Namespace',
  'settings.workspaces.egress.title': '出站代理',
  'settings.workspaces.egress.description': '创建隔离工作区前，通过明确的代理路由模型提供商流量。',
  ...
  'settings.workspaces.egress.noProxy': '不使用代理列表',
  'settings.workspaces.egress.apply': '应用出站设置',
  'settings.workspaces.saving': '正在保存...',
  'settings.workspaces.saveFailed': '无法保存安全工作区设置。',
  'settings.workspaces.export.title': '导出工作区更改',
  'settings.workspaces.export.description': '查看隔离工作区补丁，先在项目中检查，再明确应用。',
  'settings.workspaces.export.directory': '目标项目目录',
  'settings.workspaces.export.load': '加载工作区',
  'settings.workspaces.export.review': "检查更改",
  'settings.workspaces.export.nothingChanged': "自创建以来，此工作区没有任何更改。",
  'settings.workspaces.export.summary': '{files} 个文件已更改',
  'settings.workspaces.export.check': '检查更改',
  'settings.workspaces.export.apply': '应用更改',
  'settings.workspaces.export.expires': '导出将在 {time} 过期。如果应用前已过期，请重新导出。',
  'settings.workspaces.export.selectedFiles': '已选择 {count} 个文件',
  'settings.workspaces.export.selectAll': '全选',
  'settings.workspaces.export.clearSelection': '清除选择',
  'settings.workspaces.export.fileToggle': '应用 workspace 补丁时包含此文件',
  'settings.workspaces.export.hunkToggle': '包含此文本变更块',
  'settings.workspaces.export.binaryWholeFile': '二进制文件：此操作必须整体选择。',
  'settings.workspaces.export.wholeOperation': '重命名、符号链接、模式和非文本更改必须作为整体操作选择。',
  'settings.workspaces.export.failed': '无法导出工作区更改。',
  'settings.workspaces.export.checkPassed': '补丁可以干净应用。',
  'settings.workspaces.export.confirmApply': '将此工作区补丁应用到目标项目目录吗？',
  'settings.workspaces.export.confirmDiscard': '要丢弃此工作区导出工件吗？',
  'settings.workspaces.capability.adminRequired': '主机管理员必须授予工作区管理权限，才能创建、协调、清理或导出。你仍可查看和使用工作区。',
  'settings.workspaces.capability.hostApplyRequired': '主机管理员必须授予主机应用权限，才能应用工作区更改。你仍可查看和使用工作区。',
  'settings.workspaces.export.applied': '补丁已应用。',
  'settings.workspaces.lifecycle.title': '工作区生命周期',
  'settings.workspaces.lifecycle.description': '创建、检查、删除隔离工作区，或将会话移动到其中。',
  'settings.workspaces.lifecycle.create': '创建工作区',
  'settings.workspaces.lifecycle.delete': '删除工作区',
  'settings.workspaces.lifecycle.warp': '移动会话',
  'settings.workspaces.lifecycle.sessionPlaceholder': '要移动到此工作区的会话 ID',
  'settings.workspaces.lifecycle.created': '工作区已创建。',
  'settings.workspaces.lifecycle.deleted': '工作区已删除。',
  'settings.workspaces.lifecycle.warped': '会话已移动到工作区。',
  'settings.workspaces.lifecycle.createFailed': '无法创建工作区。',
  'settings.workspaces.lifecycle.deleteFailed': '无法删除工作区。',
  'settings.workspaces.lifecycle.warpFailed': '无法将会话移动到工作区。',
  'settings.workspaces.lifecycle.confirmDelete': '删除选中的工作区及其托管资源？',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.remoteInstances.clientAuth.capabilities.title': '权限',
  'settings.remoteInstances.clientAuth.capabilities.workspace.read': '查看工作区',
  'settings.remoteInstances.clientAuth.capabilities.workspace.use': '使用工作区',
  'settings.remoteInstances.clientAuth.capabilities.workspace.admin': '管理工作区',
  'settings.remoteInstances.clientAuth.capabilities.host.apply': '向主机应用更改',
  'settings.remoteInstances.clientAuth.capabilities.grant': '授予',
  'settings.remoteInstances.clientAuth.capabilities.revoke': '撤销',
  'settings.remoteInstances.clientAuth.capabilities.confirm': '要为 {client} {action}“{capability}”吗？',
  'settings.remoteInstances.clientAuth.capabilities.passwordPrompt': '请使用界面密码确认，或取消。',
  ...
  'settings.workspaces.status.refreshFailed': '无法刷新工作区状态。',
  'settings.workspaces.status.connected': "就绪",
  'settings.workspaces.status.connecting': "启动中…",
  'settings.workspaces.status.disconnected': "已停止",
  'settings.workspaces.status.error': "需要处理",
  'settings.workspaces.status.unknown': "检查中…",
  'settings.workspaces.lifecycle.empty': '未找到此项目的工作区。',
  'settings.workspaces.lifecycle.startSession': '启动会话',
  'settings.workspaces.lifecycle.startFailed': '无法在此工作区中启动会话。',
  'settings.workspaces.lifecycle.detach': '分离会话',
  'settings.workspaces.lifecycle.detached': '会话已与工作区分离。',
  'settings.workspaces.lifecycle.detachFailed': '无法分离会话。',
  'settings.workspaces.lifecycle.confirmDetach': '是否分离当前会话且不复制工作区文件更改？请先导出需要保留的更改。',
  'settings.workspaces.lifecycle.noCurrentSession': '请打开一个会话以移动或分离它。',
  'settings.workspaces.handoff.continueWorkspace': '在工作区中继续',
  'settings.workspaces.handoff.continueHost': '在主机上继续',
  'settings.workspaces.handoff.moveTitle': "移动此聊天",
  'settings.workspaces.handoff.moveHint': "开始一个带有本次对话摘要的新聊天。当前聊天保持不变。",
  'settings.workspaces.handoff.chatAlreadyHere': "此聊天已在此工作区中运行。您可以将它移回自己的电脑。",
  'settings.workspaces.handoff.moveIntoWorkspace': "移入此工作区",
  'settings.workspaces.handoff.moveToHost': "移到我的电脑",
  'settings.workspaces.handoff.noCurrentSession': '请打开一个会话，以便在新会话中继续。',
  'settings.workspaces.handoff.title': "检查将要带过去的内容",
  'settings.workspaces.handoff.description': "编辑将开启新聊天的摘要。文件、工具和附件不会带过去。",
  'settings.workspaces.handoff.fidelityWarning': '这是有限的文本上下文，并非历史记录的精确副本。',
  'settings.workspaces.handoff.sourceUnchanged': '源会话保持不变，仍可打开。',
  'settings.workspaces.handoff.filesWarning': '不包含文件更改。请另行使用工作区导出流程。',
  'settings.workspaces.handoff.omissions': '已省略 {count} 个不受支持或敏感的项目。',
  'settings.workspaces.handoff.contextAria': '新会话的可编辑上下文',
  'settings.workspaces.handoff.confirm': '确认并继续',
  'settings.workspaces.handoff.draftFailed': '无法创建交接草稿。',
  'settings.workspaces.handoff.commitFailed': '无法完成上下文交接。',
  'settings.workspaces.handoff.verifyFailed': '无法验证新会话的上下文。',
  'settings.workspaces.handoff.completed': '新会话已创建，其上下文已验证。',
  'settings.workspaces.handoff.openSource': '打开源会话',
  'settings.workspaces.handoff.openTarget': '打开新会话',
