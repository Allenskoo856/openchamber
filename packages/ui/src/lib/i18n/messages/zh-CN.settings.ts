export const settingsDict = {
  ...
  'settings.workspaces.reauth.prompt': '请使用 OpenChamber 密码确认此特权工作区操作。如果此主机没有密码，请留空。',
  ...
  'settings.workspaces.newSession.host': '主机',
  'settings.workspaces.newSession.secure': '安全工作区',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.workspaces.status.connected': '已连接',
  'settings.workspaces.status.connecting': '正在连接',
  'settings.workspaces.status.disconnected': '已断开',
  'settings.workspaces.status.error': '错误',
  'settings.workspaces.status.unknown': '未知状态',
