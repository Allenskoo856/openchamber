...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.notifications.page.messengers.title': '即时通讯通知',
  'settings.notifications.page.messengers.info': '通过传入 Webhook 将智能体通知发送到 Slack 或 Discord 频道。Webhook URL 保存在此服务器上，保存后不会再次显示。',
  'settings.notifications.page.messengers.loadFailed': '无法加载即时通讯设置。',
  'settings.notifications.page.messengers.retryAction': '重试',
  'settings.notifications.page.messengers.enableLabel': '启用 {messenger} 通知',
  'settings.notifications.page.messengers.enableAria': '启用 {messenger} 通知',
  ...
  'settings.notifications.page.messengers.webhookConfigured': 'Webhook 已配置。',
  'settings.notifications.page.messengers.replacePlaceholder': '粘贴新的 Webhook URL 以替换已保存的地址',
  'settings.notifications.page.messengers.saveAction': '保存 Webhook',
  'settings.notifications.page.messengers.removeAction': '移除 Webhook',
  'settings.notifications.page.messengers.testAction': '发送测试消息',
  'settings.notifications.page.messengers.toast.saveFailed': '无法保存即时通讯设置',
  'settings.notifications.page.messengers.toast.invalidUrl': '请输入有效的 {messenger} Webhook URL',
  'settings.notifications.page.messengers.toast.testSent': '已向 {messenger} 发送测试消息',
  'settings.notifications.page.messengers.toast.testFailed': '向 {messenger} 发送测试消息失败',
