export const settingsDict = {
  ...
  'settings.page.engines.description': '选择并管理执行引擎。',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.engines.sidebar.subtitle': '聊天会话的执行后端',
  'settings.engines.sidebar.engine.opencode': 'OpenCode',
  'settings.engines.sidebar.engine.claudeCode': 'Claude Code',
  'settings.engines.sidebar.status.ready': '就绪',
  'settings.engines.sidebar.status.needsLogin': '需要登录',
  'settings.engines.sidebar.status.missingCli': '缺少 CLI',
  'settings.engines.sidebar.status.unsupportedHost': '此主机不可用',
  'settings.engines.sidebar.status.error': '错误',
  'settings.engines.sidebar.status.unknown': '未知',
  'settings.engines.sidebar.status.loading': '正在检查…',
  'settings.engines.page.empty.selectEngine': '请从侧边栏选择引擎',
  'settings.engines.page.loadError': '无法加载引擎状态',
  'settings.engines.opencode.title': 'OpenCode',
  'settings.engines.opencode.description': '默认引擎。使用 OpenCode 提供商和智能体。',
  'settings.engines.opencode.section.about': '关于',
  'settings.engines.opencode.about.body': 'OpenCode 通过已配置的提供商运行模型。请在“提供商”中管理 API 密钥，在“智能体”中管理智能体设置。',
  'settings.engines.opencode.link.providers': '打开提供商',
  'settings.engines.opencode.link.agents': '打开智能体',
  'settings.engines.claudeCode.title': 'Claude Code',
  'settings.engines.claudeCode.description': '使用订阅用量限额的原生 Claude Code CLI。',
  'settings.engines.claudeCode.section.status': '状态',
  'settings.engines.claudeCode.field.status': '状态',
  ...
  'settings.engines.claudeCode.actions.redetect': '重新检测',
  'settings.engines.claudeCode.actions.redetectAria': '重新检测 Claude Code 状态',
  'settings.engines.claudeCode.actions.openDocs': '打开文档',
  'settings.engines.claudeCode.actions.openDocsAria': '打开 Claude Code 文档',
  'settings.engines.claudeCode.login.title': '登录 Claude',
  'settings.engines.claudeCode.login.body': '在此主机上安装 Claude CLI 并运行 claude login，以便 OpenChamber 使用你的 Claude 订阅。',
  'settings.engines.claudeCode.section.capabilities': '能力',
  'settings.engines.claudeCode.capabilities.empty': '成功检测后将显示能力列表。',
  'settings.engines.claudeCode.capability.full': '完全支持',
  'settings.engines.claudeCode.capability.partial': '部分支持',
  'settings.engines.claudeCode.capability.none': '不可用',
  'settings.engines.claudeCode.section.warnings': '警告',
  'settings.engines.claudeCode.warnHandoff.label': '从 OpenCode 切换到 Claude Code 时警告',
  'settings.engines.claudeCode.warnHandoff.aria': '从 OpenCode 切换到 Claude Code 时警告',
  'settings.engines.claudeCode.warnHandoff.info': '说明新会话使用的是 Claude 订阅，而不是 API 计费。',
  'settings.engines.claudeCode.section.apiKeys': 'API 密钥',
  'settings.engines.claudeCode.apiKeys.note': 'Anthropic API 密钥仍在 OpenCode 的“提供商”中配置。Claude Code 使用主机上的 Claude 订阅登录。',
  'settings.engines.capability.prompt': '提示',
  'settings.engines.capability.abort': '中止',
  'settings.engines.capability.resume': '恢复',
  'settings.engines.capability.streaming-text': '文本流式传输',
  'settings.engines.capability.streaming-tools': '工具流式传输',
  'settings.engines.capability.permissions': '权限',
  'settings.engines.capability.images': '图片',
  'settings.engines.capability.file-attachments': '文件附件',
  'settings.engines.capability.shell': 'Shell',
  'settings.engines.capability.slash-commands': '斜杠命令',
  'settings.engines.capability.mcp': 'MCP',
  'settings.engines.capability.subagents': '子智能体',
