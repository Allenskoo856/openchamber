export const settingsDict = {
  ...
  'settings.page.workspaces.title': '워크스페이스',
  'settings.workspaces.title': '보안 워크스페이스',
  'settings.workspaces.allowedImages': '정확한 허용 이미지 목록',
  'settings.workspaces.allowedImagesHint': '다이제스트로 고정된 이미지를 쉼표로 구분합니다. 비워 두면 선택한 이미지만 허용합니다.',
  'settings.workspaces.docker.memory': 'Docker 메모리 제한',
  'settings.workspaces.docker.cpu': 'Docker CPU 제한',
  'settings.workspaces.docker.pids': 'Docker PID 제한',
  'settings.workspaces.apple.memory': 'Apple Container 메모리 제한',
  'settings.workspaces.apple.cpu': 'Apple Container CPU 제한',
  'settings.workspaces.kubernetes.storage': '저장소',
  'settings.workspaces.kubernetes.cpuRequest': 'CPU 요청',
  'settings.workspaces.kubernetes.memoryRequest': '메모리 요청',
  'settings.workspaces.kubernetes.cpuLimit': 'CPU 제한',
  'settings.workspaces.kubernetes.memoryLimit': '메모리 제한',
  'settings.workspaces.kubernetes.connectivity': '연결 방식',
  'settings.workspaces.kubernetes.portForward': '포트 전달',
  'settings.workspaces.kubernetes.ingress': '인그레스',
  'settings.workspaces.kubernetes.ingressClass': '인그레스 클래스',
  'settings.workspaces.kubernetes.hostTemplate': 'HTTPS 호스트 템플릿',
  'settings.workspaces.kubernetes.pathTemplate': '경로 템플릿',
  'settings.workspaces.kubernetes.namespaceSelector': '컨트롤러 네임스페이스 선택기 (JSON)',
  'settings.workspaces.kubernetes.podSelector': '컨트롤러 Pod 선택기 (JSON)',
  'settings.workspaces.kubernetes.annotations': '허용 주석 (JSON)',
  'settings.workspaces.kubernetes.tlsMode': 'TLS 인증서',
  'settings.workspaces.kubernetes.existingSecret': '기존 시크릿',
  'settings.workspaces.kubernetes.certManager': '인증서 관리자',
  'settings.workspaces.kubernetes.tlsSecret': 'TLS 시크릿 이름',
  'settings.workspaces.kubernetes.clusterIssuer': '클러스터 발급자',
  'settings.workspaces.egress.mode': '외부 통신 모드',
  'settings.workspaces.egress.managed': '관리형',
  'settings.workspaces.egress.external': '외부 프록시',
  'settings.workspaces.egress.gatewayImage': '게이트웨이 이미지 다이제스트',
  'settings.workspaces.egress.preset': '관리형 사전 설정',
  'settings.workspaces.egress.restricted': '제한됨',
  'settings.workspaces.egress.custom': '사용자 지정',
  'settings.workspaces.egress.allowedDomains': '허용 도메인',
  'settings.workspaces.egress.allowedCIDRs': '허용 CIDR',
  'settings.workspaces.egress.allowedPorts': '허용 포트',
  'settings.workspaces.policy.title': '자격 증명 및 보존',
  'settings.workspaces.credentials.modelAuth': '모델 인증 권한',
  'settings.workspaces.credentials.modelAuthHint': '자격 증명은 명시적으로 부여되어 공급자 파일에 저장되며 자동 상속되지 않습니다.',
  'settings.workspaces.credentials.none': '권한 없음',
  'settings.workspaces.credentials.explicit': 'OpenCode 인증 부여',
  'settings.workspaces.retention.preserve': '삭제 시 저장소 보존',
  'settings.workspaces.retention.warning': '경고: 공급자 저장소가 남으며 관리자가 별도로 정리해야 합니다.',
  'settings.workspaces.lifecycle.reconcile': '조정',
  'settings.workspaces.lifecycle.reconnect': "다시 연결 시도",
  'settings.workspaces.lifecycle.reconciled': '워크스페이스 조정이 완료되었습니다.',
  ...
  'settings.workspaces.export.downloadFailed': '아티팩트를 다운로드하지 못했습니다.',
  'settings.workspaces.export.discardFailed': '아티팩트를 폐기하지 못했습니다.',
  'settings.workspaces.description': '명시적인 변경 내보내기와 함께 격리된 Docker 또는 Kubernetes 런타임에서 OpenCode 세션을 실행합니다.',
  'settings.workspaces.reauth.prompt': 'OpenChamber 비밀번호로 권한이 필요한 워크스페이스 작업을 확인하세요.',
  'settings.workspaces.reauth.title': '워크스페이스 작업 확인',
  'settings.workspaces.reauth.confirm': '확인',
  'settings.workspaces.reauth.failed': '권한이 필요한 워크스페이스 작업을 확인하지 못했습니다.',
  'settings.workspaces.reauth.windowHint': '확인 후 몇 분 동안 관련 권한 작업에서 비밀번호를 다시 묻지 않습니다.',
  'settings.workspaces.newSession.notConfigured': 'Secure Workspaces가 아직 설정되지 않았습니다. 먼저 설정에서 구성하고 활성화하세요.',
  'settings.workspaces.actions.close': '채팅으로 돌아가기',
  'settings.workspaces.setup.done': "완료",
  'settings.workspaces.safety.filesLabel': "프로젝트 파일",
  'settings.workspaces.safety.filesValue': "적용 전까지 변경되지 않음",
  'settings.workspaces.safety.internetLabel': "인터넷 접근",
  'settings.workspaces.safety.internetValueRestricted': "제한됨",
  'settings.workspaces.safety.internetValueProxy': "프록시를 통해",
  'settings.workspaces.advanced.hide': "고급 설정 숨기기",
  'settings.workspaces.advanced.credentialsGroup': "모델 자격 증명",
  'settings.workspaces.advanced.imagesGroup': "컨테이너 이미지",
  'settings.workspaces.advanced.limitsGroup': "리소스 제한",
  'settings.workspaces.advanced.limitsHint': "각 워크스페이스에 적용되는 상한입니다. 비워 두면 프로바이더 기본값입니다.",
  'settings.workspaces.advanced.networkGroup': "네트워크 접근",
  'settings.workspaces.advanced.clusterGroup': "클러스터 연결",
  'settings.workspaces.advanced.clusterHint': "OpenChamber가 Kubernetes 클러스터와 그 안의 워크스페이스에 연결하는 방식입니다.",
  'settings.workspaces.credentials.explicitHint': "워크스페이스 안에서 어시스턴트가 모델을 사용할 수 있습니다.",
  'settings.workspaces.credentials.noneHint': "워크스페이스 안에서 어시스턴트가 응답할 수 없습니다.",
  'settings.workspaces.setup.readyTitle': "사용할 준비가 되었습니다",
  'settings.workspaces.setup.readyHint': "새 세션을 만들고 Secure Workspace를 선택하면 프로젝트의 격리된 사본에서 작업합니다.",
  'settings.workspaces.setup.notReadyTitle': "설정이 필요합니다",
  'settings.workspaces.setup.notReadyHint': "격리된 환경에서 세션을 실행하려면 아래 단계를 완료하세요.",
  'settings.workspaces.setup.title': "설정 상태",
  'settings.workspaces.setup.stepRuntime': "컨테이너 런타임 사용 가능",
  'settings.workspaces.setup.pathTitle': "{provider} 준비",
  'settings.workspaces.setup.pathHint': "위에서부터 순서대로 진행하세요. 각 항목은 자동으로 확인되며, 가능한 단계는 앱이 처리합니다.",
  'settings.workspaces.setup.pathReadyTitle': "{provider} 준비 완료",
  'settings.workspaces.setup.pathReadyHint': "모든 요건을 충족했습니다. 한눈에 확인할 수 있도록 목록은 그대로 둡니다.",
  'settings.workspaces.setup.working': "진행 중…",
  'settings.workspaces.setup.action.create-namespace': "만들기",
  'settings.workspaces.setup.action.check-isolation': "확인하기",
  'settings.workspaces.setup.namespaceCreated': "네임스페이스를 만들었습니다.",
  'settings.workspaces.setup.namespaceExists': "해당 네임스페이스가 이미 있습니다.",
  'settings.workspaces.setup.isolationEnforced': "클러스터가 네트워크 격리를 적용합니다. 작업 공간이 실제로 격리됩니다.",
  'settings.workspaces.setup.isolationMissing': "이 클러스터는 네트워크 규칙을 받아들이지만 적용하지 않아 작업 공간이 격리되지 않습니다. Calico나 Cilium이 있는 클러스터를 요청하거나 Docker를 사용하세요.",
  ...
  'settings.workspaces.setup.step.kubernetes.cluster': "클러스터 연결",
  'settings.workspaces.setup.step.kubernetes.namespace': "네임스페이스",
  'settings.workspaces.setup.step.kubernetes.permissions': "권한",
  'settings.workspaces.setup.step.kubernetes.isolation': "네트워크 격리",
  'settings.workspaces.setup.step.apple-container.platform': "지원되는 시스템",
  'settings.workspaces.setup.step.apple-container.cli': "Apple Container 설치",
  'settings.workspaces.setup.stepInfo.docker.cli': "각 격리 작업 공간이 실행되는 컨테이너를 Docker가 제공합니다.",
  'settings.workspaces.setup.stepInfo.docker.daemon': "작업 공간을 시작하려면 Docker 엔진이 실행 중이어야 합니다.",
  'settings.workspaces.setup.stepInfo.kubernetes.cli': "kubectl은 앱이 클러스터와 통신하는 도구입니다.",
  'settings.workspaces.setup.stepInfo.kubernetes.cluster': "이 컴퓨터가 이미 접근할 수 있는 클러스터를 선택하세요. 네임스페이스도 함께 따라옵니다.",
  'settings.workspaces.setup.stepInfo.kubernetes.namespace': "작업 공간은 전용 네임스페이스를 사용해 클러스터의 나머지와 섞이지 않습니다.",
  'settings.workspaces.setup.stepInfo.kubernetes.permissions': "해당 네임스페이스에서 작업 공간 리소스를 만들 권한이 필요합니다.",
  'settings.workspaces.setup.stepInfo.kubernetes.isolation': "클러스터는 네트워크 규칙을 받아들이고도 적용하지 않을 수 있습니다. 이 확인으로 실제 적용을 검증합니다.",
  'settings.workspaces.setup.stepInfo.apple-container.platform': "Apple Container 작업 공간은 macOS에서만 동작합니다.",
  'settings.workspaces.setup.stepInfo.apple-container.cli': "Apple Container 명령줄 도구가 격리 컨테이너를 제공합니다.",
  'settings.workspaces.setup.stepEnable': "Secure Workspaces 켜짐",
  'settings.workspaces.setup.stepEnableHint': "꺼짐 — 세션이 여전히 컴퓨터에서 직접 실행됩니다.",
  'settings.workspaces.setup.stepActivate': "워크스페이스를 만들 준비 완료",
  'settings.workspaces.setup.stepActivateHint': "활성화하여 워크스페이스 런타임을 불러오세요.",
  'settings.workspaces.setup.turnOn': "켜기",
  'settings.workspaces.setup.recheck': "다시 확인",
  'settings.workspaces.setup.checking': "확인 중…",
  'settings.workspaces.where.title': "워크스페이스 실행 위치",
  'settings.workspaces.where.description': "격리된 워크스페이스를 호스팅할 런타임을 선택하세요. 사용 가능 여부는 자동으로 확인됩니다.",
  'settings.workspaces.where.dockerRecommended': "자기 컴퓨터에서는 Docker가 맞습니다. 동일하게 엄격히 격리하고, 더 빨리 시작하며, Docker 외에 준비할 것이 없습니다.",
  'settings.workspaces.where.kubernetesWhen': "이 컴퓨터가 아닌 곳에서 작업을 실행해야 할 때 Kubernetes를 선택하세요. 회사에서 받은 클러스터, 더 큰 장비, GPU가 있는 장비 등입니다. 같은 컴퓨터의 클러스터는 Docker보다 나은 점이 없습니다.",
  'settings.workspaces.safety.title': "워크스페이스가 할 수 있는 일",
  'settings.workspaces.safety.description': "생성하는 모든 워크스페이스에 적용되는 격리 규칙입니다.",
  'settings.workspaces.safety.filesText': "파일은 그대로 유지됩니다. 워크스페이스는 자체 사본에서 작업하며, 변경 사항을 검토하고 적용하기 전까지 프로젝트에는 아무것도 반영되지 않습니다.",
  'settings.workspaces.safety.internetRestricted': "인터넷 접근은 모델 제공자, 패키지 레지스트리, 아래에 추가한 도메인으로 제한됩니다.",
  'settings.workspaces.safety.internetProxy': "인터넷 접근은 고급 설정에 구성된 외부 프록시를 통해 이루어집니다.",
  'settings.workspaces.safety.credentialsHint': "워크스페이스가 모델 자격 증명 사본을 받을지 여부입니다. 없으면 워크스페이스 안에서 어시스턴트가 응답할 수 없습니다.",
  'settings.workspaces.advanced.title': "고급",
  'settings.workspaces.advanced.description': "인프라 세부 설정입니다. 기본값은 인증된 값이므로 필요한 경우에만 변경하세요.",
  'settings.workspaces.advanced.reveal': "고급 설정 표시",
  'settings.workspaces.advanced.imagesHint': "컨테이너 이미지는 다이제스트로 고정됩니다. 비워 두면 서명된 릴리스 이미지를 사용합니다.",
  'settings.workspaces.advanced.customImages': "직접 지정한 이미지 사용 중",
  'settings.workspaces.advanced.customImagesHint': "작업 공간을 실행하는 모든 곳에서 접근할 수 있어야 합니다. 비우면 OpenChamber 기본 이미지로 돌아갑니다.",
  'settings.workspaces.advanced.useBuiltInImages': "기본 이미지 사용",
  'settings.workspaces.setup.imageUnpullable': "클러스터가 작업 공간 이미지를 내려받지 못했습니다. 아무것도 시작하지 못해 격리는 확인하지 않았습니다. 고급 설정의 이미지를 확인하세요. 이 컴퓨터에서만 접근되는 레지스트리는 클러스터에서 쓸 수 없습니다.",
  'settings.workspaces.advanced.egressHint': "워크스페이스의 아웃바운드 네트워크 규칙입니다.",
  'settings.workspaces.advanced.domainsHint': "추가 도메인을 쉼표로 구분해 입력하세요. 모델 제공자는 자동으로 허용됩니다.",
  'settings.workspaces.export.alreadyApplied': "이미 파일에 적용됨",
  'settings.workspaces.export.hostChanged': "파일이 변경되었습니다 — 적용 전에 확인하세요",
  'settings.workspaces.lifecycle.advanced': '고급 작업',
  'settings.workspaces.lifecycle.connectHint': '워크스페이스가 아직 연결되지 않았습니다. 잠시 기다리거나 복구를 실행해 다시 연결하세요.',
  'settings.workspaces.lifecycle.chooseProject': 'Secure Workspaces를 관리할 프로젝트를 선택하세요.',
  'settings.workspaces.lifecycle.createWith': "{provider} 워크스페이스 만들기",
  'settings.workspaces.progress.creating': "워크스페이스를 만드는 중입니다. 1분 정도 걸릴 수 있습니다…",
  'settings.workspaces.progress.deleting': "워크스페이스와 컨테이너를 삭제하는 중…",
  'settings.workspaces.progress.repairing': "워크스페이스를 복구하는 중…",
  'settings.workspaces.progress.exporting': "검토할 변경 사항을 수집하는 중…",
  'settings.workspaces.progress.checking': "변경 사항을 파일과 대조하는 중…",
  'settings.workspaces.progress.applying': "변경 사항을 파일에 적용하는 중…",
  'settings.workspaces.lifecycle.noProject': "선택된 프로젝트 없음",
  'settings.workspaces.lifecycle.emptyHint': 'Secure Workspace는 프로젝트를 격리된 컨테이너에서 실행합니다. 변경 사항을 검토하고 적용하기 전까지 AI는 파일을 건드리지 않습니다.',
  'settings.workspaces.errors.policyMismatch': '이 워크스페이스는 이전 보안 정책으로 생성되어 작업이 비활성화되었습니다. 삭제하고 새 워크스페이스를 만들어 계속하세요. 삭제는 계속 가능합니다.',
  'settings.workspaces.lifecycle.drifted': "이전 설정",
  'settings.workspaces.lifecycle.driftedHint': "현재 설정 이전에 만들어졌습니다. 실행과 삭제는 되지만, 다시 만들기 전까지 변경 사항을 내보낼 수 없습니다.",
  'settings.workspaces.remediation.policyIncomplete': "이 프로바이더를 사용하려면 추가 설정이 필요합니다. 아래 고급 설정을 열어 완료하세요.",
  'settings.workspaces.remediation.docker.cliMissing': 'Docker가 설치되어 있지 않거나 PATH에 없습니다. Docker Desktop을 설치하고 시작한 후 다시 검증하세요.',
  'settings.workspaces.remediation.docker.daemonUnavailable': 'Docker가 설치되어 있지만 응답하지 않습니다. Docker Desktop을 시작하고 다시 검증하세요.',
  'settings.workspaces.remediation.kubernetes.cliMissing': 'kubectl이 설치되어 있지 않거나 PATH에 없습니다. kubectl을 설치하고 다시 검증하세요.',
  'settings.workspaces.remediation.kubernetes.notConfigured': "연결된 Kubernetes 클러스터가 없습니다. Docker Desktop에서 Kubernetes를 활성화하거나 기존 클러스터로 kubectl을 설정한 후 다시 확인하세요.",
  'settings.workspaces.remediation.kubernetes.clusterUnreachable': 'kubectl이 구성된 클러스터에 연결할 수 없습니다. kubeconfig, 컨텍스트, 클러스터 가용성을 확인하세요.',
  'settings.workspaces.remediation.kubernetes.namespaceMissing': '구성된 네임스페이스가 클러스터에 없습니다. 생성하거나 다른 네임스페이스를 선택하세요.',
  'settings.workspaces.remediation.apple.cliMissing': 'Apple Container CLI가 설치되어 있지 않습니다. Apple Container를 설치하고 다시 검증하세요.',
  'settings.workspaces.remediation.apple.daemonUnavailable': 'Apple Container가 설치되어 있지만 시스템 서비스가 실행 중이 아닙니다. 시작한 후 다시 검증하세요.',
  ...
  'settings.workspaces.reauth.op.configure': 'Secure Workspaces 설정 변경',
  'settings.workspaces.reauth.op.validate': '프로바이더 확인',
  'settings.workspaces.reauth.op.setup': "설정 단계 완료",
  'settings.workspaces.reauth.op.reconcile': '워크스페이스 복구',
  'settings.workspaces.reauth.op.export': '검토용으로 변경 사항 내보내기',
  'settings.workspaces.reauth.op.hostApply': '검토한 변경 사항을 파일에 적용',
  'settings.workspaces.reauth.op.hostCapabilities': '기기 권한 변경',
  'settings.workspaces.newSession.groupLabel': "어시스턴트가 작업할 위치",
  'settings.workspaces.newSession.host': "내 컴퓨터",
  'settings.workspaces.newSession.secureHint': "어시스턴트는 컨테이너 안의 프로젝트 사본에서 작업합니다. 검토하고 적용해야만 파일이 변경됩니다.",
  'settings.workspaces.newSession.secureHintWithRuntime': "{runtime}에서 실행됩니다. 어시스턴트는 프로젝트 사본에서 작업하며, 검토하고 적용해야만 파일이 변경됩니다.",
  'settings.workspaces.newSession.secure': "격리된 작업 공간",
  'settings.workspaces.newSession.chooseProject': '보안 워크스페이스를 사용하기 전에 프로젝트를 선택하세요.',
  'settings.workspaces.newSession.progress': '{phase}',
  'settings.workspaces.newSession.partial': '워크스페이스 세션이 부분적으로 생성되었습니다. 중복 생성 없이 복구하려면 다시 시도하세요.',
  'settings.workspaces.newSession.phasePreparing': '보안 워크스페이스를 준비하는 중…',
  'settings.workspaces.newSession.phaseConnecting': '보안 워크스페이스에 연결하는 중…',
  'settings.workspaces.newSession.phaseCreating': '보안 세션을 생성하는 중…',
  'settings.workspaces.newSession.phaseOpening': '보안 세션을 여는 중…',
  'settings.workspaces.newSession.retry': '안전하게 다시 시도',
  'settings.workspaces.newSession.startFailed': "격리된 작업 공간을 시작하지 못했습니다. 설정을 확인하고 다시 시도하세요.",
  'settings.workspaces.enable': '보안 워크스페이스 사용',
  'settings.workspaces.enableHint': '더 안전한 에이전트 실행을 위해 격리된 런타임을 만들 수 있습니다.',
  'settings.workspaces.image': '런타임 이미지',
  'settings.workspaces.requirePinnedImage': '고정된 이미지 태그 또는 digest 필요',
  ...
  'settings.workspaces.actions.validating': '확인 중...',
  'settings.workspaces.status.available': '사용 가능',
  'settings.workspaces.status.unavailable': '사용 불가',
  'settings.workspaces.status.unsupported': '이 런타임에서는 workspace provider 관리가 지원되지 않습니다.',
  'settings.workspaces.status.notChecked': '확인 안 됨',
  'settings.workspaces.compatibility.title': 'OpenCode workspace 지원',
  'settings.workspaces.compatibility.active': '보안 workspace provider가 실행 중인 OpenCode 서버에 설정되어 활성화되었습니다.',
  'settings.workspaces.compatibility.configuredInactive': '보안 workspace provider가 설정되었지만 아직 활성화되지 않았습니다. workspace를 만들기 전에 활성화하세요.',
  'settings.workspaces.compatibility.notConfigured': '보안 workspace provider가 아직 설정되지 않았습니다.',
  'settings.workspaces.compatibility.unsupported': '실행 중인 OpenCode 서버가 experimental workspace API를 제공하지 않습니다. plugin 설치 후 OpenCode를 업데이트하거나 다시 시작하세요.',
  'settings.workspaces.compatibility.activate': 'Provider 활성화',
  'settings.workspaces.compatibility.recheck': '다시 확인',
  'settings.workspaces.compatibility.activated': 'Workspace provider가 활성화되었습니다.',
  'settings.workspaces.compatibility.pending': 'Workspace provider가 설정되었습니다. OpenCode가 로드를 마친 뒤 다시 확인하세요.',
  'settings.workspaces.compatibility.manualRestart': '외부 OpenCode가 설정되었지만 OpenChamber가 다시 시작할 수 없습니다. 해당 OpenCode 서버를 다시 시작한 뒤 다시 확인하세요.',
  'settings.workspaces.compatibility.failed': 'Workspace 지원을 확인할 수 없습니다.',
  'settings.workspaces.kubernetes.context': 'Kubernetes 컨텍스트',
  'settings.workspaces.kubernetes.namespace': 'Namespace',
  'settings.workspaces.egress.title': '송신 프록시',
  'settings.workspaces.egress.description': '격리된 워크스페이스를 만들기 전에 모델 제공자 트래픽을 명시적 프록시로 라우팅합니다.',
  'settings.workspaces.egress.httpProxy': 'HTTP 프록시 URL',
  'settings.workspaces.egress.proxyCIDR': '프록시 CIDR',
  'settings.workspaces.egress.dnsCIDRs': 'DNS CIDR',
  'settings.workspaces.egress.noProxy': '프록시 제외 목록',
  'settings.workspaces.egress.apply': '송신 설정 적용',
  'settings.workspaces.saving': '저장 중...',
  'settings.workspaces.saveFailed': '보안 작업 공간 설정을 저장하지 못했습니다.',
  'settings.workspaces.export.title': '작업 공간 변경 내보내기',
  'settings.workspaces.export.description': '격리된 작업 공간의 패치를 검토하고 프로젝트에 적용 가능한지 확인한 뒤 명시적으로 적용합니다.',
  'settings.workspaces.export.directory': '대상 프로젝트 디렉터리',
  'settings.workspaces.export.load': '작업 공간 불러오기',
  'settings.workspaces.export.review': "변경 사항 확인",
  'settings.workspaces.export.nothingChanged': "이 작업 공간은 생성된 이후 변경된 것이 없습니다.",
  'settings.workspaces.export.summary': '변경된 파일 {files}개',
  'settings.workspaces.export.check': '변경 사항 확인',
  'settings.workspaces.export.apply': '변경 사항 적용',
  'settings.workspaces.export.expires': '내보내기는 {time}에 만료됩니다. 적용하기 전에 만료되면 다시 내보내세요.',
  'settings.workspaces.export.selectedFiles': '{count}개 파일 선택됨',
  'settings.workspaces.export.selectAll': '모두 선택',
  'settings.workspaces.export.clearSelection': '선택 지우기',
  'settings.workspaces.export.fileToggle': 'Workspace 패치 적용에 이 파일 포함',
  'settings.workspaces.export.hunkToggle': '이 텍스트 변경 블록 포함',
  'settings.workspaces.export.binaryWholeFile': '바이너리 파일: 이 작업은 전체 단위로 선택됩니다.',
  'settings.workspaces.export.wholeOperation': '이름 변경, 심볼릭 링크, 모드 및 비텍스트 변경은 전체 작업 단위로 선택됩니다.',
  'settings.workspaces.export.failed': '작업 공간 변경 사항을 내보내지 못했습니다.',
  'settings.workspaces.export.checkPassed': '패치가 깨끗하게 적용됩니다.',
  'settings.workspaces.export.confirmApply': '이 작업 공간 패치를 대상 프로젝트 디렉터리에 적용할까요?',
  'settings.workspaces.export.confirmDiscard': '이 작업 공간 내보내기 아티팩트를 폐기할까요?',
  'settings.workspaces.capability.adminRequired': '생성, 조정, 정리 또는 내보내기를 사용하려면 호스트 관리자가 작업 공간 관리 권한을 부여해야 합니다. 작업 공간 보기와 사용은 계속할 수 있습니다.',
  'settings.workspaces.capability.hostApplyRequired': '작업 공간 변경 사항을 적용하려면 호스트 관리자가 호스트 적용 권한을 부여해야 합니다. 작업 공간 보기와 사용은 계속할 수 있습니다.',
  'settings.workspaces.export.applied': '패치가 적용되었습니다.',
  'settings.workspaces.lifecycle.title': '워크스페이스 수명 주기',
  'settings.workspaces.lifecycle.description': '격리된 워크스페이스를 만들고, 확인하고, 삭제하거나 세션을 이동합니다.',
  'settings.workspaces.lifecycle.create': '워크스페이스 만들기',
  'settings.workspaces.lifecycle.delete': '워크스페이스 삭제',
  'settings.workspaces.lifecycle.warp': '세션 이동',
  'settings.workspaces.lifecycle.sessionPlaceholder': '이 워크스페이스로 이동할 세션 ID',
  'settings.workspaces.lifecycle.created': '워크스페이스를 만들었습니다.',
  'settings.workspaces.lifecycle.deleted': '워크스페이스를 삭제했습니다.',
  'settings.workspaces.lifecycle.warped': '세션을 워크스페이스로 이동했습니다.',
  'settings.workspaces.lifecycle.createFailed': '워크스페이스를 만들 수 없습니다.',
  'settings.workspaces.lifecycle.deleteFailed': '워크스페이스를 삭제할 수 없습니다.',
  'settings.workspaces.lifecycle.warpFailed': '세션을 워크스페이스로 이동할 수 없습니다.',
  'settings.workspaces.lifecycle.confirmDelete': '선택한 워크스페이스와 관리 리소스를 삭제할까요?',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.remoteInstances.clientAuth.capabilities.title': '권한',
  'settings.remoteInstances.clientAuth.capabilities.workspace.read': '워크스페이스 보기',
  'settings.remoteInstances.clientAuth.capabilities.workspace.use': '워크스페이스 사용',
  'settings.remoteInstances.clientAuth.capabilities.workspace.admin': '워크스페이스 관리',
  'settings.remoteInstances.clientAuth.capabilities.host.apply': '호스트에 변경 사항 적용',
  'settings.remoteInstances.clientAuth.capabilities.grant': '부여',
  'settings.remoteInstances.clientAuth.capabilities.revoke': '취소',
  'settings.remoteInstances.clientAuth.capabilities.confirm': '{client}에 “{capability}” 권한을 {action}하시겠습니까?',
  'settings.remoteInstances.clientAuth.capabilities.passwordPrompt': 'UI 비밀번호로 확인하거나 취소하세요.',
  ...
  'settings.workspaces.status.refreshFailed': '워크스페이스 상태를 새로 고칠 수 없습니다.',
  'settings.workspaces.status.connected': "준비됨",
  'settings.workspaces.status.connecting': "시작 중…",
  'settings.workspaces.status.disconnected': "중지됨",
  'settings.workspaces.status.error': "확인 필요",
  'settings.workspaces.status.unknown': "확인 중…",
  'settings.workspaces.lifecycle.empty': '이 프로젝트의 워크스페이스가 없습니다.',
  'settings.workspaces.lifecycle.startSession': '세션 시작',
  'settings.workspaces.lifecycle.startFailed': '이 워크스페이스에서 세션을 시작할 수 없습니다.',
  'settings.workspaces.lifecycle.detach': '세션 분리',
  'settings.workspaces.lifecycle.detached': '세션이 워크스페이스에서 분리되었습니다.',
  'settings.workspaces.lifecycle.detachFailed': '세션을 분리할 수 없습니다.',
  'settings.workspaces.lifecycle.confirmDetach': '워크스페이스 파일 변경 사항을 복사하지 않고 현재 세션을 분리하시겠습니까? 유지할 변경 사항을 먼저 내보내세요.',
  'settings.workspaces.lifecycle.noCurrentSession': '이동하거나 분리할 세션을 여세요.',
  'settings.workspaces.handoff.continueWorkspace': '워크스페이스에서 계속',
  'settings.workspaces.handoff.continueHost': '호스트에서 계속',
  'settings.workspaces.handoff.moveTitle': "이 채팅 옮기기",
  'settings.workspaces.handoff.moveHint': "이 대화의 요약을 담은 새 채팅을 시작합니다. 지금 채팅은 그대로 남습니다.",
  'settings.workspaces.handoff.chatAlreadyHere': "이 채팅은 이미 이 워크스페이스에서 실행 중입니다. 컴퓨터로 되돌릴 수 있습니다.",
  'settings.workspaces.handoff.moveIntoWorkspace': "이 워크스페이스로",
  'settings.workspaces.handoff.moveToHost': "내 컴퓨터로",
  'settings.workspaces.handoff.noCurrentSession': '새 세션에서 계속할 세션을 여세요.',
  'settings.workspaces.handoff.title': "이어질 내용 확인",
  'settings.workspaces.handoff.description': "새 채팅을 시작할 요약을 편집하세요. 파일, 도구, 첨부는 이어지지 않습니다.",
  'settings.workspaces.handoff.fidelityWarning': '이는 제한된 텍스트 컨텍스트이며 기록의 정확한 복사본이 아닙니다.',
  'settings.workspaces.handoff.sourceUnchanged': '원본 세션은 변경되지 않으며 계속 열 수 있습니다.',
  'settings.workspaces.handoff.filesWarning': '파일 변경 사항은 포함되지 않습니다. 워크스페이스 내보내기 흐름을 별도로 사용하세요.',
  'settings.workspaces.handoff.omissions': '지원되지 않거나 민감한 항목 {count}개를 제외했습니다.',
  'settings.workspaces.handoff.contextAria': '새 세션의 편집 가능한 컨텍스트',
  'settings.workspaces.handoff.confirm': '확인하고 계속',
  'settings.workspaces.handoff.draftFailed': '전달 초안을 만들 수 없습니다.',
  'settings.workspaces.handoff.commitFailed': '컨텍스트 전달을 완료할 수 없습니다.',
  'settings.workspaces.handoff.verifyFailed': '새 세션 컨텍스트를 확인할 수 없습니다.',
  'settings.workspaces.handoff.completed': '새 세션을 만들고 컨텍스트를 확인했습니다.',
  'settings.workspaces.handoff.openSource': '원본 열기',
  'settings.workspaces.handoff.openTarget': '새 세션 열기',
  'settings.workspaces.handoff.cleanupTarget': '고립된 세션 정리',
  'settings.workspaces.handoff.cleanupComplete': '고립된 대상 세션을 삭제했습니다.',
  'settings.workspaces.handoff.cleanupFailed': '고립된 대상 세션을 삭제할 수 없습니다.',
} as const;
