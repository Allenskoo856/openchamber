...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.mcp.page.actions.showTools': '도구 표시',
  'settings.mcp.page.actions.loadingTools': '도구 불러오는 중...',
  'settings.mcp.page.actions.refreshTools': '새로고침',
  'settings.mcp.page.toolsDialog.title': 'MCP 도구',
  'settings.mcp.page.toolsDialog.description': '이 MCP 서버가 현재 노출하는 도구입니다.',
  ...
  'settings.mcp.page.toast.listToolsFailed': 'MCP 도구 목록을 가져오지 못했습니다',
