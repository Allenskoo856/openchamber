...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.notifications.page.messengers.title': '메신저 알림',
  'settings.notifications.page.messengers.info': '수신 웹훅을 통해 에이전트 알림을 Slack 또는 Discord 채널에 게시합니다. 웹훅 URL은 이 서버에 저장되며 저장 후 다시 표시되지 않습니다.',
  'settings.notifications.page.messengers.loadFailed': '메신저 설정을 불러오지 못했습니다.',
  'settings.notifications.page.messengers.retryAction': '다시 시도',
  'settings.notifications.page.messengers.enableLabel': '{messenger} 알림 사용',
  'settings.notifications.page.messengers.enableAria': '{messenger} 알림 사용',
  'settings.notifications.page.messengers.webhookLabel': '웹훅 URL',
  'settings.notifications.page.messengers.webhookAria': '{messenger} 웹훅 URL',
  'settings.notifications.page.messengers.webhookConfigured': '웹훅이 구성되었습니다.',
  'settings.notifications.page.messengers.replacePlaceholder': '저장된 URL을 교체하려면 새 웹훅 URL을 붙여넣으세요',
  'settings.notifications.page.messengers.saveAction': '웹훅 저장',
  'settings.notifications.page.messengers.removeAction': '웹훅 제거',
  'settings.notifications.page.messengers.testAction': '테스트 메시지 보내기',
  'settings.notifications.page.messengers.toast.saveFailed': '메신저 설정을 저장하지 못했습니다',
  'settings.notifications.page.messengers.toast.invalidUrl': '유효한 {messenger} 웹훅 URL을 입력하세요',
  'settings.notifications.page.messengers.toast.testSent': '{messenger}에 테스트 메시지를 보냈습니다',
  'settings.notifications.page.messengers.toast.testFailed': '{messenger}에 테스트 메시지를 보내지 못했습니다',
