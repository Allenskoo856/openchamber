export const settingsDict = {
  ...
  'settings.page.engines.title': '엔진',
  'settings.page.engines.description': '실행 엔진을 선택하고 관리합니다.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.engines.sidebar.title': '엔진',
  'settings.engines.sidebar.subtitle': '채팅 세션용 실행 백엔드',
  'settings.engines.sidebar.engine.opencode': 'OpenCode',
  'settings.engines.sidebar.engine.claudeCode': 'Claude Code',
  'settings.engines.sidebar.status.ready': '준비됨',
  'settings.engines.sidebar.status.needsLogin': '로그인 필요',
  'settings.engines.sidebar.status.missingCli': 'CLI 없음',
  'settings.engines.sidebar.status.unsupportedHost': '이 호스트에서 사용 불가',
  'settings.engines.sidebar.status.error': '오류',
  'settings.engines.sidebar.status.unknown': '알 수 없음',
  'settings.engines.sidebar.status.loading': '확인 중…',
  'settings.engines.page.empty.selectEngine': '사이드바에서 엔진을 선택하세요',
  'settings.engines.page.loadError': '엔진 상태를 불러올 수 없습니다',
  'settings.engines.opencode.title': 'OpenCode',
  'settings.engines.opencode.description': '기본 엔진입니다. OpenCode 프로바이더와 에이전트를 사용합니다.',
  'settings.engines.opencode.section.about': '정보',
  'settings.engines.opencode.about.body': 'OpenCode는 구성된 프로바이더를 통해 모델을 실행합니다. API 키는 프로바이더에서, 에이전트 설정은 에이전트에서 관리하세요.',
  'settings.engines.opencode.link.providers': '프로바이더 열기',
  'settings.engines.opencode.link.agents': '에이전트 열기',
  'settings.engines.claudeCode.title': 'Claude Code',
  'settings.engines.claudeCode.description': '구독 사용량 한도를 사용하는 네이티브 Claude Code CLI입니다.',
  'settings.engines.claudeCode.section.status': '상태',
  'settings.engines.claudeCode.field.status': '상태',
  'settings.engines.claudeCode.field.version': '버전',
  'settings.engines.claudeCode.status.version': '{version}',
  'settings.engines.claudeCode.status.versionUnknown': '알 수 없음',
  'settings.engines.claudeCode.actions.redetect': '다시 감지',
  'settings.engines.claudeCode.actions.redetectAria': 'Claude Code 상태 다시 감지',
  'settings.engines.claudeCode.actions.openDocs': '문서 열기',
  'settings.engines.claudeCode.actions.openDocsAria': 'Claude Code 문서 열기',
  'settings.engines.claudeCode.login.title': 'Claude로 로그인',
  'settings.engines.claudeCode.login.body': '이 호스트에 Claude CLI를 설치하고 claude login을 실행하면 OpenChamber가 Claude 구독을 사용할 수 있습니다.',
  'settings.engines.claudeCode.section.capabilities': '기능',
  'settings.engines.claudeCode.capabilities.empty': '감지에 성공하면 기능 목록이 표시됩니다.',
  'settings.engines.claudeCode.capability.full': '완전 지원',
  'settings.engines.claudeCode.capability.partial': '부분 지원',
  'settings.engines.claudeCode.capability.none': '사용 불가',
  'settings.engines.claudeCode.section.warnings': '경고',
  'settings.engines.claudeCode.warnHandoff.label': 'OpenCode에서 Claude Code로 전환할 때 경고',
  'settings.engines.claudeCode.warnHandoff.aria': 'OpenCode에서 Claude Code로 전환할 때 경고',
  'settings.engines.claudeCode.warnHandoff.info': '새 세션이 API 결제가 아니라 Claude 구독을 사용한다는 점을 설명합니다.',
  'settings.engines.claudeCode.section.apiKeys': 'API 키',
  'settings.engines.claudeCode.apiKeys.note': 'Anthropic API 키는 OpenCode의 프로바이더에 그대로 둡니다. Claude Code는 호스트의 Claude 구독 로그인을 사용합니다.',
  'settings.engines.capability.prompt': '프롬프트',
  'settings.engines.capability.abort': '중단',
  'settings.engines.capability.resume': '재개',
  'settings.engines.capability.streaming-text': '텍스트 스트리밍',
  'settings.engines.capability.streaming-tools': '도구 스트리밍',
  'settings.engines.capability.permissions': '권한',
  'settings.engines.capability.images': '이미지',
  'settings.engines.capability.file-attachments': '파일 첨부',
  'settings.engines.capability.shell': '셸',
  'settings.engines.capability.slash-commands': '슬래시 명령',
  'settings.engines.capability.mcp': 'MCP',
  'settings.engines.capability.subagents': '서브에이전트',
  'settings.engines.capability.multirun': 'MultiRun',
  'settings.engines.capability.goal': 'Goal 모드',
  'settings.engines.capability.openchamber-tool': 'OpenChamber 도구',
