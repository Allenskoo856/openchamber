export const settingsDict = {
  ...
  'settings.workspaces.reauth.prompt': 'OpenChamber 비밀번호로 권한이 필요한 워크스페이스 작업을 확인하세요. 이 호스트에 비밀번호가 없으면 비워 두세요.',
  ...
  'settings.workspaces.newSession.host': '호스트',
  'settings.workspaces.newSession.secure': '보안 워크스페이스',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.workspaces.status.connected': '연결됨',
  'settings.workspaces.status.connecting': '연결 중',
  'settings.workspaces.status.disconnected': '연결 끊김',
  'settings.workspaces.status.error': '오류',
  'settings.workspaces.status.unknown': '알 수 없는 상태',
