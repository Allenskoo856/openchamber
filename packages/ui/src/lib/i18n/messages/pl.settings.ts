export const settingsDict = {
  ...
  'settings.workspaces.reauth.prompt': 'Potwierdź tę uprzywilejowaną operację obszaru roboczego hasłem OpenChamber. Pozostaw puste, jeśli ten host nie ma hasła.',
  ...
  'settings.workspaces.newSession.host': 'Host',
  'settings.workspaces.newSession.secure': 'Bezpieczny obszar roboczy',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.workspaces.status.connected': 'Połączono',
  'settings.workspaces.status.connecting': 'Łączenie',
  'settings.workspaces.status.disconnected': 'Rozłączono',
  'settings.workspaces.status.error': 'Błąd',
  'settings.workspaces.status.unknown': 'Nieznany stan',
