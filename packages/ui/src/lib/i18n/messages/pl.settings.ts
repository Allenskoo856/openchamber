export const settingsDict = {
  ...
  'settings.page.engines.title': 'Silniki',
  'settings.page.engines.description': 'Wybieraj i zarządzaj silnikami wykonawczymi.',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.engines.sidebar.title': 'Silniki',
  'settings.engines.sidebar.subtitle': 'Backendy wykonania dla sesji czatu',
  'settings.engines.sidebar.engine.opencode': 'OpenCode',
  'settings.engines.sidebar.engine.claudeCode': 'Claude Code',
  'settings.engines.sidebar.status.ready': 'Gotowy',
  'settings.engines.sidebar.status.needsLogin': 'Wymagane logowanie',
  'settings.engines.sidebar.status.missingCli': 'Brak CLI',
  'settings.engines.sidebar.status.unsupportedHost': 'Niedostępny tutaj',
  'settings.engines.sidebar.status.error': 'Błąd',
  'settings.engines.sidebar.status.unknown': 'Nieznany',
  'settings.engines.sidebar.status.loading': 'Sprawdzanie…',
  'settings.engines.page.empty.selectEngine': 'Wybierz silnik na pasku bocznym',
  'settings.engines.page.loadError': 'Nie udało się wczytać stanu silnika',
  'settings.engines.opencode.title': 'OpenCode',
  'settings.engines.opencode.description': 'Domyślny silnik. Korzysta z dostawców i agentów OpenCode.',
  'settings.engines.opencode.section.about': 'Informacje',
  'settings.engines.opencode.about.body': 'OpenCode uruchamia modele przez skonfigurowanych dostawców. Kluczami API zarządzaj w Dostawcach, a ustawieniami agentów w Agentach.',
  'settings.engines.opencode.link.providers': 'Otwórz Dostawców',
  'settings.engines.opencode.link.agents': 'Otwórz Agentów',
  'settings.engines.claudeCode.title': 'Claude Code',
  'settings.engines.claudeCode.description': 'Natywne Claude Code CLI z limitami subskrypcji.',
  'settings.engines.claudeCode.section.status': 'Status',
  'settings.engines.claudeCode.field.status': 'Status',
  'settings.engines.claudeCode.field.version': 'Wersja',
  'settings.engines.claudeCode.status.version': '{version}',
  'settings.engines.claudeCode.status.versionUnknown': 'Nieznana',
  'settings.engines.claudeCode.actions.redetect': 'Wykryj ponownie',
  'settings.engines.claudeCode.actions.redetectAria': 'Ponownie wykryj status Claude Code',
  'settings.engines.claudeCode.actions.openDocs': 'Otwórz dokumentację',
  'settings.engines.claudeCode.actions.openDocsAria': 'Otwórz dokumentację Claude Code',
  'settings.engines.claudeCode.login.title': 'Zaloguj się do Claude',
  'settings.engines.claudeCode.login.body': 'Zainstaluj Claude CLI i uruchom claude login na tym hoście, aby OpenChamber korzystał z Twojej subskrypcji Claude.',
  'settings.engines.claudeCode.section.capabilities': 'Możliwości',
  'settings.engines.claudeCode.capabilities.empty': 'Możliwości pojawią się po udanym wykryciu.',
  'settings.engines.claudeCode.capability.full': 'Pełne',
  'settings.engines.claudeCode.capability.partial': 'Częściowe',
  'settings.engines.claudeCode.capability.none': 'Niedostępne',
  'settings.engines.claudeCode.section.warnings': 'Ostrzeżenia',
  'settings.engines.claudeCode.warnHandoff.label': 'Ostrzegaj przy przełączaniu z OpenCode na Claude Code',
  'settings.engines.claudeCode.warnHandoff.aria': 'Ostrzegaj przy przełączaniu z OpenCode na Claude Code',
  'settings.engines.claudeCode.warnHandoff.info': 'Wyjaśnia, że nowa sesja korzysta z subskrypcji Claude, a nie z rozliczeń API.',
  'settings.engines.claudeCode.section.apiKeys': 'Klucze API',
  'settings.engines.claudeCode.apiKeys.note': 'Klucze API Anthropic pozostają w Dostawcach OpenCode. Claude Code używa logowania subskrypcji Claude na hoście.',
  'settings.engines.capability.prompt': 'Prompt',
  'settings.engines.capability.abort': 'Przerwanie',
  'settings.engines.capability.resume': 'Wznawianie',
  'settings.engines.capability.streaming-text': 'Strumieniowanie tekstu',
  'settings.engines.capability.streaming-tools': 'Strumieniowanie narzędzi',
  'settings.engines.capability.permissions': 'Uprawnienia',
  'settings.engines.capability.images': 'Obrazy',
  'settings.engines.capability.file-attachments': 'Załączniki plików',
  'settings.engines.capability.shell': 'Shell',
  'settings.engines.capability.slash-commands': 'Polecenia slash',
  'settings.engines.capability.mcp': 'MCP',
  'settings.engines.capability.subagents': 'Subagenci',
  'settings.engines.capability.multirun': 'MultiRun',
  'settings.engines.capability.goal': 'Tryb Goal',
  'settings.engines.capability.openchamber-tool': 'Narzędzie OpenChamber',
