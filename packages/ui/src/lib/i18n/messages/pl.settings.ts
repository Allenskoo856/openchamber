export const settingsDict = {
  ...
  'settings.notifications.page.messengers.title': 'Powiadomienia komunikatorów',
  'settings.notifications.page.messengers.info': 'Publikuj powiadomienia agenta na kanałach Slack lub Discord za pomocą webhooków przychodzących. Adresy URL webhooków są przechowywane na tym serwerze i po zapisaniu nie są ponownie wyświetlane.',
  'settings.notifications.page.messengers.loadFailed': 'Nie udało się wczytać ustawień komunikatorów.',
  'settings.notifications.page.messengers.retryAction': 'Spróbuj ponownie',
  'settings.notifications.page.messengers.enableLabel': 'Włącz powiadomienia {messenger}',
  'settings.notifications.page.messengers.enableAria': 'Włącz powiadomienia {messenger}',
  'settings.notifications.page.messengers.webhookLabel': 'Adres URL webhooka',
  'settings.notifications.page.messengers.webhookAria': 'Adres URL webhooka {messenger}',
  'settings.notifications.page.messengers.webhookConfigured': 'Webhook skonfigurowany.',
  'settings.notifications.page.messengers.replacePlaceholder': 'Wklej nowy adres URL webhooka, aby zastąpić zapisany',
  'settings.notifications.page.messengers.saveAction': 'Zapisz webhook',
  'settings.notifications.page.messengers.removeAction': 'Usuń webhook',
  'settings.notifications.page.messengers.testAction': 'Wyślij wiadomość testową',
  'settings.notifications.page.messengers.toast.saveFailed': 'Nie udało się zapisać ustawień komunikatorów',
  'settings.notifications.page.messengers.toast.invalidUrl': 'Wprowadź prawidłowy adres URL webhooka {messenger}',
  'settings.notifications.page.messengers.toast.testSent': 'Wysłano wiadomość testową do {messenger}',
  'settings.notifications.page.messengers.toast.testFailed': 'Nie udało się wysłać wiadomości testowej do {messenger}',
