export const settingsDict = {
  ...
  'settings.page.workspaces.title': 'Obszary robocze',
  'settings.workspaces.title': 'Bezpieczne obszary robocze',
  'settings.workspaces.allowedImages': 'Dokładna lista dozwolonych obrazów',
  'settings.workspaces.allowedImagesHint': 'Obrazy przypięte skrótem, rozdzielone przecinkami. Puste pole zezwala tylko na wybrany obraz.',
  'settings.workspaces.docker.memory': 'Limit pamięci Docker',
  'settings.workspaces.docker.cpu': 'Limit CPU Docker',
  'settings.workspaces.docker.pids': 'Limit PID Docker',
  'settings.workspaces.apple.memory': 'Limit pamięci Apple Container',
  'settings.workspaces.apple.cpu': 'Limit CPU Apple Container',
  'settings.workspaces.kubernetes.storage': 'Pamięć masowa',
  'settings.workspaces.kubernetes.cpuRequest': 'Żądanie CPU',
  'settings.workspaces.kubernetes.memoryRequest': 'Żądanie pamięci',
  'settings.workspaces.kubernetes.cpuLimit': 'Limit CPU',
  'settings.workspaces.kubernetes.memoryLimit': 'Limit pamięci',
  'settings.workspaces.kubernetes.connectivity': 'Łączność',
  'settings.workspaces.kubernetes.portForward': 'Przekierowanie portu',
  'settings.workspaces.kubernetes.ingress': 'Ruch przychodzący',
  'settings.workspaces.kubernetes.ingressClass': 'Klasa ruchu przychodzącego',
  'settings.workspaces.kubernetes.hostTemplate': 'Szablon hosta HTTPS',
  'settings.workspaces.kubernetes.pathTemplate': 'Szablon ścieżki',
  'settings.workspaces.kubernetes.namespaceSelector': 'Selektor przestrzeni kontrolera (JSON)',
  'settings.workspaces.kubernetes.podSelector': 'Selektor poda kontrolera (JSON)',
  'settings.workspaces.kubernetes.annotations': 'Dozwolone adnotacje (JSON)',
  'settings.workspaces.kubernetes.tlsMode': 'Certyfikat TLS',
  'settings.workspaces.kubernetes.existingSecret': 'Istniejący sekret',
  'settings.workspaces.kubernetes.certManager': 'Menedżer certyfikatów',
  'settings.workspaces.kubernetes.tlsSecret': 'Nazwa sekretu TLS',
  'settings.workspaces.kubernetes.clusterIssuer': 'Wystawca klastra',
  'settings.workspaces.egress.mode': 'Tryb ruchu wychodzącego',
  'settings.workspaces.egress.managed': 'Zarządzany',
  'settings.workspaces.egress.external': 'Zewnętrzny serwer proxy',
  'settings.workspaces.egress.gatewayImage': 'Skrót obrazu bramy',
  'settings.workspaces.egress.preset': 'Profil zarządzany',
  'settings.workspaces.egress.restricted': 'Ograniczony',
  'settings.workspaces.egress.custom': 'Niestandardowy',
  'settings.workspaces.egress.allowedDomains': 'Dozwolone domeny',
  'settings.workspaces.egress.allowedCIDRs': 'Dozwolone CIDR',
  'settings.workspaces.egress.allowedPorts': 'Dozwolone porty',
  'settings.workspaces.policy.title': 'Poświadczenia i przechowywanie',
  'settings.workspaces.credentials.modelAuth': 'Zgoda na uwierzytelnienie modelu',
  'settings.workspaces.credentials.modelAuthHint': 'Poświadczenia są jawnie przyznawane i przechowywane w plikach dostawcy, bez automatycznego dziedziczenia.',
  'settings.workspaces.credentials.none': 'Bez zgody',
  'settings.workspaces.credentials.explicit': 'Przyznaj uwierzytelnienie OpenCode',
  'settings.workspaces.retention.preserve': 'Zachowaj pamięć po usunięciu',
  'settings.workspaces.retention.warning': 'Ostrzeżenie: pamięć dostawcy pozostanie i będzie wymagać osobnego czyszczenia przez administratora.',
  'settings.workspaces.lifecycle.reconcile': 'Uzgodnij',
  'settings.workspaces.lifecycle.reconnect': "Spróbuj połączyć ponownie",
  'settings.workspaces.lifecycle.reconciled': 'Uzgadnianie zakończone.',
  ...
  'settings.workspaces.export.downloadFailed': 'Nie udało się pobrać artefaktu.',
  'settings.workspaces.export.discardFailed': 'Nie udało się odrzucić artefaktu.',
  'settings.workspaces.description': 'Uruchamiaj sesje OpenCode w izolowanych runtime Docker lub Kubernetes z jawnym eksportem zmian.',
  'settings.workspaces.reauth.prompt': 'Potwierdź tę uprzywilejowaną operację obszaru roboczego hasłem OpenChamber.',
  'settings.workspaces.reauth.title': 'Potwierdź operację obszaru roboczego',
  'settings.workspaces.reauth.confirm': 'Potwierdź',
  'settings.workspaces.reauth.failed': 'Nie udało się potwierdzić tej uprzywilejowanej operacji obszaru roboczego.',
  'settings.workspaces.reauth.windowHint': 'Po potwierdzeniu powiązane działania uprzywilejowane nie będą ponownie prosić o hasło przez kilka minut.',
  'settings.workspaces.newSession.notConfigured': 'Secure Workspaces nie zostały jeszcze skonfigurowane. Najpierw skonfiguruj je i aktywuj w Ustawieniach.',
  'settings.workspaces.actions.close': 'Wróć do czatu',
  'settings.workspaces.setup.done': "Gotowe",
  'settings.workspaces.safety.filesLabel': "Pliki Twojego projektu",
  'settings.workspaces.safety.filesValue': "Nienaruszone do momentu zastosowania",
  'settings.workspaces.safety.internetLabel': "Dostęp do internetu",
  'settings.workspaces.safety.internetValueRestricted': "Ograniczony",
  'settings.workspaces.safety.internetValueProxy': "Przez Twoje proxy",
  'settings.workspaces.advanced.hide': "Ukryj ustawienia zaawansowane",
  'settings.workspaces.advanced.credentialsGroup': "Poświadczenia modeli",
  'settings.workspaces.advanced.imagesGroup': "Obrazy kontenerów",
  'settings.workspaces.advanced.limitsGroup': "Limity zasobów",
  'settings.workspaces.advanced.limitsHint': "Limity dla każdego obszaru roboczego. Puste = wartość domyślna dostawcy.",
  'settings.workspaces.advanced.networkGroup': "Dostęp do sieci",
  'settings.workspaces.advanced.clusterGroup': "Połączenie z klastrem",
  'settings.workspaces.advanced.clusterHint': "Jak OpenChamber łączy się z klastrem Kubernetes i obszarami roboczymi w nim.",
  'settings.workspaces.credentials.explicitHint': "Asystent może korzystać z Twoich modeli w obszarze roboczym.",
  'settings.workspaces.credentials.noneHint': "Asystent nie może odpowiadać w obszarze roboczym.",
  'settings.workspaces.setup.readyTitle': "Gotowe do użycia",
  'settings.workspaces.setup.readyHint': "Utwórz nową sesję i wybierz Secure Workspace, aby pracować na izolowanej kopii projektu.",
  'settings.workspaces.setup.notReadyTitle': "Wymagana konfiguracja",
  'settings.workspaces.setup.notReadyHint': "Wykonaj poniższe kroki, aby uruchamiać sesje w izolowanym środowisku.",
  'settings.workspaces.setup.title': "Stan konfiguracji",
  'settings.workspaces.setup.stepRuntime': "Środowisko kontenerów dostępne",
  'settings.workspaces.setup.pathTitle': "Przygotowanie {provider}",
  'settings.workspaces.setup.pathHint': "Wykonuj je po kolei. Każdy jest sprawdzany automatycznie, a co się da, aplikacja zrobi sama.",
  'settings.workspaces.setup.pathReadyTitle': "{provider} jest gotowy",
  'settings.workspaces.setup.pathReadyHint': "Wszystkie wymagania są spełnione. Lista zostaje, byś mógł to sprawdzić jednym spojrzeniem.",
  'settings.workspaces.setup.working': "Pracuję…",
  'settings.workspaces.setup.action.create-namespace': "Utwórz",
  'settings.workspaces.setup.action.check-isolation': "Sprawdź",
  'settings.workspaces.setup.namespaceCreated': "Utworzono przestrzeń nazw.",
  'settings.workspaces.setup.namespaceExists': "Ta przestrzeń nazw już istnieje.",
  'settings.workspaces.setup.isolationEnforced': "Twój klaster egzekwuje izolację sieciową. Obszary będą naprawdę odizolowane.",
  'settings.workspaces.setup.isolationMissing': "Ten klaster przyjmuje reguły sieciowe, ale ich nie egzekwuje, więc obszary nie byłyby odizolowane. Poproś o klaster z Calico lub Cilium albo użyj Dockera.",
  'settings.workspaces.setup.isolationDockerDesktop': "Jeśli to wbudowany Kubernetes w Docker Desktop: tryb kubeadm nie zawiera niczego, co egzekwuje reguły sieciowe, a tryb kind tak. Pomoże zmiana trybu albo po prostu użycie Dockera.",
  'settings.workspaces.setup.isolationUnknown': "Sprawdzenie izolacji nie dało rozstrzygnięcia. Spróbuj ponownie lub sprawdź, czy klaster może uruchamiać pody.",
  'settings.workspaces.setup.actionFailed': "Nie udało się wykonać tego kroku.",
  'settings.workspaces.setup.actionCancelled': "Anulowano — nic nie zmieniono.",
  'settings.workspaces.setup.step.docker.cli': "Docker zainstalowany",
  'settings.workspaces.setup.step.docker.daemon': "Docker uruchomiony",
  'settings.workspaces.setup.step.kubernetes.cli': "kubectl zainstalowany",
  'settings.workspaces.setup.step.kubernetes.cluster': "Połączenie z klastrem",
  'settings.workspaces.setup.step.kubernetes.namespace': "Przestrzeń nazw",
  'settings.workspaces.setup.step.kubernetes.permissions': "Uprawnienia",
  'settings.workspaces.setup.step.kubernetes.isolation': "Izolacja sieciowa",
  'settings.workspaces.setup.step.apple-container.platform': "Obsługiwany system",
  'settings.workspaces.setup.step.apple-container.cli': "Apple Container zainstalowany",
  'settings.workspaces.setup.stepInfo.docker.cli': "Docker udostępnia kontener, w którym działa każdy izolowany obszar.",
  'settings.workspaces.setup.stepInfo.docker.daemon': "Silnik Dockera musi działać, zanim obszar wystartuje.",
  'settings.workspaces.setup.stepInfo.kubernetes.cli': "kubectl to narzędzie, którym aplikacja rozmawia z klastrem.",
  'settings.workspaces.setup.stepInfo.kubernetes.cluster': "Wybierz klaster, do którego ten komputer już ma dostęp. Przestrzeń nazw przychodzi razem z nim.",
  'settings.workspaces.setup.stepInfo.kubernetes.namespace': "Obszary mają własną przestrzeń nazw, oddzieloną od reszty klastra.",
  'settings.workspaces.setup.stepInfo.kubernetes.permissions': "Twoje konto musi móc tworzyć zasoby obszaru w tej przestrzeni nazw.",
  'settings.workspaces.setup.stepInfo.kubernetes.isolation': "Klaster może przyjmować reguły sieciowe, nie stosując ich. To sprawdzenie dowodzi, że Twój je stosuje.",
  'settings.workspaces.setup.stepInfo.apple-container.platform': "Obszary Apple Container działają tylko na macOS.",
  'settings.workspaces.setup.stepInfo.apple-container.cli': "Narzędzie wiersza poleceń Apple Container udostępnia izolowany kontener.",
  'settings.workspaces.setup.stepEnable': "Secure Workspaces włączone",
  'settings.workspaces.setup.stepEnableHint': "Wyłączone — sesje nadal działają bezpośrednio na Twoim komputerze.",
  'settings.workspaces.setup.stepActivate': "Gotowe do tworzenia obszarów roboczych",
  'settings.workspaces.setup.stepActivateHint': "Aktywuj, aby wczytać środowisko uruchomieniowe.",
  'settings.workspaces.setup.turnOn': "Włącz",
  'settings.workspaces.setup.recheck': "Sprawdź ponownie",
  'settings.workspaces.setup.checking': "Sprawdzanie…",
  'settings.workspaces.where.title': "Gdzie działają obszary robocze",
  'settings.workspaces.where.description': "Wybierz środowisko dla izolowanych obszarów roboczych. Dostępność sprawdzana jest automatycznie.",
  'settings.workspaces.where.dockerRecommended': "Na własnym komputerze Docker to właściwy wybór: izoluje równie ściśle, startuje szybciej i nie wymaga niczego poza samym Dockerem.",
  'settings.workspaces.where.kubernetesWhen': "Wybierz Kubernetes, gdy praca ma działać poza tym komputerem — na klastrze od pracodawcy, na mocniejszej maszynie albo z GPU. Klaster na tym samym komputerze nie daje nic ponad Dockera.",
  'settings.workspaces.safety.title': "Co może obszar roboczy",
  'settings.workspaces.safety.description': "Zasady izolacji obowiązujące dla każdego tworzonego obszaru roboczego.",
  'settings.workspaces.safety.filesText': "Twoje pliki pozostają nietknięte: obszar roboczy pracuje na własnej kopii, a nic nie trafia do projektu, dopóki nie sprawdzisz zmian i ich nie zastosujesz.",
  'settings.workspaces.safety.internetRestricted': "Dostęp do internetu ograniczony do dostawców modeli, repozytoriów pakietów i domen dodanych poniżej.",
  'settings.workspaces.safety.internetProxy': "Dostęp do internetu odbywa się przez zewnętrzne proxy skonfigurowane w sekcji Zaawansowane.",
  'settings.workspaces.safety.credentialsHint': "Czy obszar roboczy otrzymuje kopię Twoich poświadczeń modeli. Bez nich asystent nie odpowie wewnątrz obszaru.",
  'settings.workspaces.advanced.title': "Zaawansowane",
  'settings.workspaces.advanced.description': "Szczegóły infrastruktury. Wartości domyślne są certyfikowane — zmieniaj tylko świadomie.",
  'settings.workspaces.advanced.reveal': "Pokaż ustawienia zaawansowane",
  'settings.workspaces.advanced.imagesHint': "Obrazy kontenerów są przypięte skrótem. Pozostaw puste, aby użyć podpisanych obrazów wydania.",
  'settings.workspaces.advanced.customImages': "Używane są własne obrazy",
  'settings.workspaces.advanced.customImagesHint': "Wszystko, co uruchamia obszar, musi mieć do nich dostęp. Wyczyść te pola, aby wrócić do obrazów dostarczanych z OpenChamber.",
  'settings.workspaces.advanced.useBuiltInImages': "Użyj wbudowanych",
  'settings.workspaces.setup.imageUnpullable': "Klaster nie może pobrać obrazu obszaru. Izolacji nie sprawdzono, bo nic się nie uruchomiło. Sprawdź obrazy w Zaawansowanych — rejestr dostępny tylko z tego komputera nie zadziała dla klastra.",
  'settings.workspaces.advanced.egressHint': "Reguły ruchu wychodzącego dla obszarów roboczych.",
  'settings.workspaces.advanced.domainsHint': "Dodatkowe domeny po przecinku. Dostawcy modeli są dozwoleni automatycznie.",
  'settings.workspaces.export.alreadyApplied': "Już w Twoich plikach",
  'settings.workspaces.export.hostChanged': "Twój plik się zmienił — sprawdź przed zastosowaniem",
  'settings.workspaces.lifecycle.advanced': 'Działania zaawansowane',
  'settings.workspaces.lifecycle.connectHint': 'Obszar roboczy nie jest jeszcze połączony. Poczekaj chwilę lub uruchom Naprawę, aby połączyć go ponownie.',
  'settings.workspaces.lifecycle.chooseProject': 'Wybierz projekt, aby zarządzać jego Secure Workspaces.',
  'settings.workspaces.lifecycle.createWith': "Utwórz obszar {provider}",
  'settings.workspaces.progress.creating': "Tworzenie obszaru — może to potrwać minutę…",
  'settings.workspaces.progress.deleting': "Usuwanie obszaru i jego kontenerów…",
  'settings.workspaces.progress.repairing': "Naprawianie obszaru…",
  'settings.workspaces.progress.exporting': "Zbieranie zmian do przeglądu…",
  'settings.workspaces.progress.checking': "Porównywanie zmian z Twoimi plikami…",
  'settings.workspaces.progress.applying': "Stosowanie zmian do Twoich plików…",
  'settings.workspaces.lifecycle.noProject': "Nie wybrano projektu",
  'settings.workspaces.lifecycle.emptyHint': 'Secure Workspace uruchamia projekt w izolowanym kontenerze — AI może pracować bez dotykania Twoich plików, dopóki nie przejrzysz i nie zastosujesz zmian.',
  'settings.workspaces.errors.policyMismatch': 'Ten obszar roboczy utworzono według starszej polityki bezpieczeństwa, więc jego działania są wyłączone. Usuń go i utwórz nowy, aby kontynuować — usuwanie nadal działa.',
  'settings.workspaces.lifecycle.drifted': "Starsze ustawienia",
  'settings.workspaces.lifecycle.driftedHint': "Utworzony przed obecnymi ustawieniami. Działa i można go usunąć, ale jego zmian nie da się wyeksportować bez ponownego utworzenia.",
  'settings.workspaces.remediation.policyIncomplete': "Ten dostawca wymaga dodatkowej konfiguracji. Otwórz „Zaawansowane” poniżej, aby ją uzupełnić.",
  'settings.workspaces.remediation.docker.cliMissing': 'Docker nie jest zainstalowany lub nie ma go w PATH. Zainstaluj Docker Desktop, uruchom go i zweryfikuj ponownie.',
  'settings.workspaces.remediation.docker.daemonUnavailable': 'Docker jest zainstalowany, ale nie odpowiada. Uruchom Docker Desktop i zweryfikuj ponownie.',
  'settings.workspaces.remediation.kubernetes.cliMissing': 'kubectl nie jest zainstalowany lub nie ma go w PATH. Zainstaluj kubectl i zweryfikuj ponownie.',
  'settings.workspaces.remediation.kubernetes.notConfigured': "Nie podłączono klastra Kubernetes. Włącz Kubernetes w Docker Desktop albo skieruj kubectl na istniejący klaster, a następnie sprawdź ponownie.",
  'settings.workspaces.remediation.kubernetes.clusterUnreachable': 'kubectl nie może połączyć się ze skonfigurowanym klastrem. Sprawdź kubeconfig, kontekst i dostępność klastra.',
  'settings.workspaces.remediation.kubernetes.namespaceMissing': 'Skonfigurowana przestrzeń nazw nie istnieje w klastrze. Utwórz ją lub wybierz inną.',
  'settings.workspaces.remediation.apple.cliMissing': 'Interfejs CLI Apple Container nie jest zainstalowany. Zainstaluj Apple Container i zweryfikuj ponownie.',
  'settings.workspaces.remediation.apple.daemonUnavailable': 'Apple Container jest zainstalowany, ale jego usługa systemowa nie działa. Uruchom ją i zweryfikuj ponownie.',
  'settings.workspaces.remediation.apple.unsupportedPlatform': 'Apple Container jest dostępny tylko w systemie macOS.',
  'settings.workspaces.remediation.apple.managedEgress': 'Apple Container wymaga obecnie trybu ruchu wychodzącego przez zewnętrzny proxy.',
  'settings.workspaces.reauth.setupRequired': 'Uprzywilejowane działania na obszarach roboczych wymagają niezależnego hasła interfejsu OpenChamber, które nie zostało jeszcze skonfigurowane na tym serwerze. Ustaw hasło interfejsu (lub zarejestruj klucz dostępu) i spróbuj ponownie.',
  'settings.workspaces.reauth.openPasswordSettings': "Skonfiguruj",
  'settings.workspaces.reauth.op.workspaceCreate': 'Utwórz Secure Workspace',
  'settings.workspaces.reauth.op.sessionStart': 'Rozpocznij sesję w Secure Workspace',
  'settings.workspaces.reauth.op.cleanup': 'Usuń obszar roboczy',
  'settings.workspaces.reauth.op.configure': 'Zmień ustawienia Secure Workspaces',
  'settings.workspaces.reauth.op.validate': 'Sprawdź dostawcę',
  'settings.workspaces.reauth.op.setup': "wykonać krok konfiguracji",
  'settings.workspaces.reauth.op.reconcile': 'Napraw obszar roboczy',
  'settings.workspaces.reauth.op.export': 'Wyeksportuj zmiany do przeglądu',
  'settings.workspaces.reauth.op.hostApply': 'Zastosuj sprawdzone zmiany do plików',
  'settings.workspaces.reauth.op.hostCapabilities': 'Zmień uprawnienia urządzenia',
  'settings.workspaces.newSession.groupLabel': "Gdzie asystent ma pracować?",
  'settings.workspaces.newSession.host': "Mój komputer",
  'settings.workspaces.newSession.secureHint': "Asystent pracuje na kopii projektu w kontenerze. Twoje pliki zmienią się dopiero po przejrzeniu i zastosowaniu.",
  'settings.workspaces.newSession.secureHintWithRuntime': "Uruchomi się w {runtime}. Asystent pracuje na kopii projektu; Twoje pliki zmienią się dopiero po przejrzeniu i zastosowaniu.",
  'settings.workspaces.newSession.secure': "Izolowany obszar",
  'settings.workspaces.newSession.chooseProject': 'Wybierz projekt przed użyciem bezpiecznego obszaru roboczego.',
  'settings.workspaces.newSession.progress': '{phase}',
  'settings.workspaces.newSession.partial': 'Sesja obszaru roboczego została utworzona częściowo. Ponów próbę, aby ją odzyskać bez tworzenia duplikatu.',
  'settings.workspaces.newSession.phasePreparing': 'Przygotowywanie bezpiecznego obszaru roboczego…',
  'settings.workspaces.newSession.phaseConnecting': 'Łączenie z bezpiecznym obszarem roboczym…',
  'settings.workspaces.newSession.phaseCreating': 'Tworzenie bezpiecznej sesji…',
  'settings.workspaces.newSession.phaseOpening': 'Otwieranie bezpiecznej sesji…',
  'settings.workspaces.newSession.retry': 'Ponów bezpiecznie',
  'settings.workspaces.newSession.startFailed': "Nie udało się uruchomić izolowanego obszaru. Sprawdź konfigurację w Ustawieniach i spróbuj ponownie.",
  'settings.workspaces.enable': 'Włącz bezpieczne obszary robocze',
  'settings.workspaces.enableHint': 'Pozwala tworzyć izolowane runtime dla bezpieczniejszego wykonywania agentów.',
  'settings.workspaces.image': 'Obraz runtime',
  'settings.workspaces.requirePinnedImage': 'Wymagaj przypiętych tagów obrazu lub digestów',
  ...
  'settings.workspaces.actions.validating': 'Sprawdzanie...',
  'settings.workspaces.status.available': 'Dostępne',
  'settings.workspaces.status.unavailable': 'Niedostępne',
  'settings.workspaces.status.unsupported': 'Zarządzanie providerami workspace nie jest dostępne w tym runtime.',
  'settings.workspaces.status.notChecked': 'Nie sprawdzono',
  'settings.workspaces.compatibility.title': 'Obsługa obszarów roboczych w OpenCode',
  'settings.workspaces.compatibility.active': 'Providery bezpiecznych obszarów roboczych są skonfigurowane i aktywne w działającym serwerze OpenCode.',
  'settings.workspaces.compatibility.configuredInactive': 'Providery bezpiecznych obszarów roboczych są skonfigurowane, ale nie są jeszcze aktywne. Aktywuj je przed tworzeniem obszarów.',
  'settings.workspaces.compatibility.notConfigured': 'Providery bezpiecznych obszarów roboczych nie są jeszcze skonfigurowane.',
  'settings.workspaces.compatibility.unsupported': 'Działający serwer OpenCode nie udostępnia eksperymentalnego API obszarów roboczych. Zaktualizuj lub uruchom ponownie OpenCode po zainstalowaniu pluginu.',
  'settings.workspaces.compatibility.activate': 'Aktywuj providery',
  'settings.workspaces.compatibility.recheck': 'Sprawdź ponownie',
  'settings.workspaces.compatibility.activated': 'Providery obszarów roboczych są aktywne.',
  'settings.workspaces.compatibility.pending': 'Providery obszarów roboczych są skonfigurowane. Sprawdź ponownie, gdy OpenCode zakończy ich ładowanie.',
  'settings.workspaces.compatibility.manualRestart': 'Zewnętrzny OpenCode jest skonfigurowany, ale OpenChamber nie może go uruchomić ponownie. Uruchom ponownie ten serwer OpenCode i sprawdź ponownie.',
  'settings.workspaces.compatibility.failed': 'Nie udało się sprawdzić obsługi obszarów roboczych.',
  'settings.workspaces.kubernetes.context': 'Kontekst Kubernetes',
  'settings.workspaces.kubernetes.namespace': 'Namespace',
  'settings.workspaces.egress.title': 'Proxy ruchu wychodzącego',
  'settings.workspaces.egress.description': 'Kieruj ruch do dostawców modeli przez jawny proxy przed tworzeniem izolowanych obszarów roboczych.',
  'settings.workspaces.egress.httpProxy': 'URL proxy HTTP',
  'settings.workspaces.egress.proxyCIDR': 'CIDR proxy',
  'settings.workspaces.egress.dnsCIDRs': 'CIDR-y DNS',
  'settings.workspaces.egress.noProxy': 'Lista bez proxy',
  'settings.workspaces.egress.apply': 'Zastosuj ustawienia wyjścia',
  'settings.workspaces.saving': 'Zapisywanie...',
  'settings.workspaces.saveFailed': 'Nie udało się zapisać ustawień bezpiecznych obszarów roboczych.',
  'settings.workspaces.export.title': 'Eksport zmian obszaru roboczego',
  'settings.workspaces.export.description': 'Przejrzyj łatkę z izolowanego obszaru, sprawdź ją względem projektu i zastosuj jawnie.',
  'settings.workspaces.export.directory': 'Docelowy katalog projektu',
  'settings.workspaces.export.load': 'Wczytaj obszary',
  'settings.workspaces.export.review': "Sprawdź zmiany",
  'settings.workspaces.export.nothingChanged': "W tym obszarze nic się nie zmieniło od jego utworzenia.",
  'settings.workspaces.export.summary': 'Zmienione pliki: {files}',
  'settings.workspaces.export.check': 'Sprawdź zmiany',
  'settings.workspaces.export.apply': 'Zastosuj zmiany',
  'settings.workspaces.export.expires': 'Eksport wygasa o {time}. Wyeksportuj ponownie, jeśli wygaśnie przed zastosowaniem.',
  'settings.workspaces.export.selectedFiles': 'Wybrano plików: {count}',
  'settings.workspaces.export.selectAll': 'Zaznacz wszystko',
  'settings.workspaces.export.clearSelection': 'Wyczyść wybór',
  'settings.workspaces.export.fileToggle': 'Uwzględnij ten plik przy stosowaniu łatki obszaru roboczego',
  'settings.workspaces.export.hunkToggle': 'Uwzględnij ten fragment tekstu',
  'settings.workspaces.export.binaryWholeFile': 'Plik binarny: ta operacja jest wybierana w całości.',
  'settings.workspaces.export.wholeOperation': 'Zmiany nazw, dowiązania symboliczne, tryby i zmiany nietekstowe są wybierane jako całe operacje.',
  'settings.workspaces.export.failed': 'Nie udało się wyeksportować zmian obszaru roboczego.',
  'settings.workspaces.export.checkPassed': 'Łatka stosuje się bez konfliktów.',
  'settings.workspaces.export.confirmApply': 'Zastosować tę łatkę obszaru roboczego do docelowego katalogu projektu?',
  'settings.workspaces.export.confirmDiscard': 'Odrzucić ten artefakt eksportu obszaru roboczego?',
  'settings.workspaces.capability.adminRequired': 'Administrator hosta musi przyznać uprawnienie do administrowania obszarami roboczymi, aby można było tworzyć, uzgadniać, czyścić lub eksportować. Nadal możesz wyświetlać obszary robocze i z nich korzystać.',
  'settings.workspaces.capability.hostApplyRequired': 'Administrator hosta musi przyznać uprawnienie do stosowania zmian na hoście. Nadal możesz wyświetlać obszary robocze i z nich korzystać.',
  'settings.workspaces.export.applied': 'Łatka zastosowana.',
  'settings.workspaces.lifecycle.title': 'Cykl życia obszaru roboczego',
  'settings.workspaces.lifecycle.description': 'Twórz, sprawdzaj, usuwaj lub przenoś sesje do izolowanych obszarów roboczych.',
  'settings.workspaces.lifecycle.create': 'Utwórz obszar',
  'settings.workspaces.lifecycle.delete': 'Usuń obszar',
  'settings.workspaces.lifecycle.warp': 'Przenieś sesję',
  'settings.workspaces.lifecycle.sessionPlaceholder': 'ID sesji do przeniesienia do tego obszaru',
  'settings.workspaces.lifecycle.created': 'Obszar roboczy utworzony.',
  'settings.workspaces.lifecycle.deleted': 'Obszar roboczy usunięty.',
  'settings.workspaces.lifecycle.warped': 'Sesję przeniesiono do obszaru roboczego.',
  'settings.workspaces.lifecycle.createFailed': 'Nie udało się utworzyć obszaru roboczego.',
  'settings.workspaces.lifecycle.deleteFailed': 'Nie udało się usunąć obszaru roboczego.',
  'settings.workspaces.lifecycle.warpFailed': 'Nie udało się przenieść sesji do obszaru roboczego.',
  'settings.workspaces.lifecycle.confirmDelete': 'Usunąć wybrany obszar roboczy i jego zarządzane zasoby?',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.remoteInstances.clientAuth.capabilities.title': 'Uprawnienia',
  'settings.remoteInstances.clientAuth.capabilities.workspace.read': 'Wyświetlanie obszarów roboczych',
  'settings.remoteInstances.clientAuth.capabilities.workspace.use': 'Używanie obszarów roboczych',
  'settings.remoteInstances.clientAuth.capabilities.workspace.admin': 'Administrowanie obszarami roboczymi',
  'settings.remoteInstances.clientAuth.capabilities.host.apply': 'Stosowanie zmian na hoście',
  'settings.remoteInstances.clientAuth.capabilities.grant': 'Nadać',
  'settings.remoteInstances.clientAuth.capabilities.revoke': 'Odebrać',
  'settings.remoteInstances.clientAuth.capabilities.confirm': '{action} uprawnienie „{capability}” dla {client}?',
  'settings.remoteInstances.clientAuth.capabilities.passwordPrompt': 'Potwierdź hasłem interfejsu lub anuluj.',
  ...
  'settings.workspaces.status.refreshFailed': 'Nie udało się odświeżyć stanu obszaru roboczego.',
  'settings.workspaces.status.connected': "Gotowy",
  'settings.workspaces.status.connecting': "Uruchamianie…",
  'settings.workspaces.status.disconnected': "Zatrzymany",
  'settings.workspaces.status.error': "Wymaga uwagi",
  'settings.workspaces.status.unknown': "Sprawdzanie…",
  'settings.workspaces.lifecycle.empty': 'Nie znaleziono obszarów roboczych dla tego projektu.',
  'settings.workspaces.lifecycle.startSession': 'Rozpocznij sesję',
  'settings.workspaces.lifecycle.startFailed': 'Nie udało się rozpocząć sesji w tym obszarze roboczym.',
  'settings.workspaces.lifecycle.detach': 'Odłącz sesję',
  'settings.workspaces.lifecycle.detached': 'Sesja została odłączona od obszaru roboczego.',
  'settings.workspaces.lifecycle.detachFailed': 'Nie udało się odłączyć sesji.',
  'settings.workspaces.lifecycle.confirmDetach': 'Odłączyć bieżącą sesję bez kopiowania zmian plików? Najpierw wyeksportuj zmiany, które chcesz zachować.',
  'settings.workspaces.lifecycle.noCurrentSession': 'Otwórz sesję, aby ją przenieść lub odłączyć.',
  'settings.workspaces.handoff.continueWorkspace': 'Kontynuuj w obszarze roboczym',
  'settings.workspaces.handoff.continueHost': 'Kontynuuj na hoście',
  'settings.workspaces.handoff.moveTitle': "Przenieś ten czat",
  'settings.workspaces.handoff.moveHint': "Rozpoczyna nowy czat z podsumowaniem tego. Ten czat pozostaje bez zmian.",
  'settings.workspaces.handoff.chatAlreadyHere': "Ten czat działa już w tym obszarze. Możesz przenieść go z powrotem na komputer.",
  'settings.workspaces.handoff.moveIntoWorkspace': "Do tego obszaru",
  'settings.workspaces.handoff.moveToHost': "Na mój komputer",
  'settings.workspaces.handoff.noCurrentSession': 'Otwórz sesję, aby kontynuować ją w nowej sesji.',
  'settings.workspaces.handoff.title': "Sprawdź, co zostanie przeniesione",
  'settings.workspaces.handoff.description': "Edytuj podsumowanie, od którego zacznie się nowy czat. Pliki, narzędzia i załączniki nie są przenoszone.",
  'settings.workspaces.handoff.fidelityWarning': 'To ograniczony kontekst tekstowy, a nie dokładna kopia historii.',
  'settings.workspaces.handoff.sourceUnchanged': 'Sesja źródłowa pozostaje bez zmian i nadal można ją otworzyć.',
  'settings.workspaces.handoff.filesWarning': 'Zmiany plików nie są dołączone. Użyj osobno eksportu obszaru roboczego.',
  'settings.workspaces.handoff.omissions': 'Pominięto {count} nieobsługiwanych lub poufnych elementów.',
  'settings.workspaces.handoff.contextAria': 'Edytowalny kontekst nowej sesji',
  'settings.workspaces.handoff.confirm': 'Potwierdź i kontynuuj',
  'settings.workspaces.handoff.draftFailed': 'Nie udało się utworzyć wersji roboczej przekazania.',
  'settings.workspaces.handoff.commitFailed': 'Nie udało się zakończyć przekazania kontekstu.',
  'settings.workspaces.handoff.verifyFailed': 'Nie udało się zweryfikować kontekstu nowej sesji.',
  'settings.workspaces.handoff.completed': 'Nowa sesja została utworzona, a jej kontekst zweryfikowano.',
  'settings.workspaces.handoff.openSource': 'Otwórz źródło',
  'settings.workspaces.handoff.openTarget': 'Otwórz nową sesję',
