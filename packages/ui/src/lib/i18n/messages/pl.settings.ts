...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Dodaj urządzenie',
  ...
  'settings.workspaces.handoff.title': 'Sprawdź przekazanie kontekstu',
  'settings.workspaces.handoff.description': 'Sprawdź i edytuj tekst, który rozpocznie nową sesję docelową.',
