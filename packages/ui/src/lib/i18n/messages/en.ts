...
export const dict = {
  ...
  'sessions.sidebar.session.engine.claudeCodeAria': 'Claude Code engine',
  'sessions.sidebar.session.engine.claudeCodeTooltip': 'Running on Claude Code',
  ...
  'gitView.pr.comments.addAll': 'Add all to chat',
  ...
  'chat.modelControls.cacheRead': 'Cache read',
  'chat.modelControls.cacheWrite': 'Cache write',
  'chat.modelControls.costInOutShort': 'In {input} · Out {output}',
  'chat.modelControls.modalityInputAria': '{modality} input',
  'chat.modelControls.modalityOutputAria': '{modality} output',
  ...
  'chat.engines.permissionMode.acceptEdits': 'Accept edits',
  'chat.engines.permissionMode.plan': 'Plan',
  'chat.engines.permissionMode.dontAsk': "Don't ask",
  'chat.engines.permissionMode.aria': 'Permission mode: {mode}',
  'chat.engines.permissionMode.tooltip': 'Permission mode: {mode}',
  'chat.engines.effort.label': 'Effort',
  'chat.engines.effort.default': 'Default',
  'chat.engines.effort.low': 'Low',
  'chat.engines.effort.medium': 'Medium',
  'chat.engines.effort.high': 'High',
  'chat.engines.effort.xhigh': 'Extra high',
  'chat.engines.effort.max': 'Max',
  'chat.engines.effort.aria': 'Effort: {level}',
  'chat.engines.effort.tooltip': 'Effort: {level}',
  'chat.engines.capability.goalUnsupported': 'Goals are only available on OpenCode. Switch this session to OpenCode to use goals.',
  'chat.engines.capability.multirunUnsupported': 'MultiRun is only available on OpenCode. Switch this session to OpenCode to start a MultiRun.',
  'chat.handoff.billingDialog.title': 'Continue on Claude Code?',
  'chat.handoff.billingDialog.body': 'This starts a new session on Claude Code using your Claude subscription usage limits. OpenCode API providers are unchanged. Conversation text is copied as context; the original session stays intact.',
  'chat.handoff.billingDialog.continue': 'Continue',
  'chat.handoff.billingDialog.cancel': 'Cancel',
  'chat.handoff.billingDialog.dontShowAgain': 'Don’t show this again',
  'chat.handoff.billingDialog.dontShowAgainAria': 'Don’t show this handoff billing notice again',
