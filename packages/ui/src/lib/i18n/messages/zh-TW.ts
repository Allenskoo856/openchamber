...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.engines.permissionMode.acceptEdits': '接受編輯',
  'chat.engines.permissionMode.plan': '計畫',
  'chat.engines.permissionMode.dontAsk': '不要詢問',
  'chat.engines.permissionMode.aria': '權限模式：{mode}',
  'chat.engines.permissionMode.tooltip': '權限模式：{mode}',
