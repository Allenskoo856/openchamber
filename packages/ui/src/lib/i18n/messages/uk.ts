...
export const dict: Record<I18nKey, string> = {
  ...
  "gitView.pr.actions.resolveFailedChecks": "Закріпити зафейлені чеки",
  "gitView.pr.actions.resolveFailedChecksAria": "Закріпити зафейлені чеки в контексті чату",
  "gitView.pr.actions.savePr": "Зберегти PR",
  "gitView.pr.actions.savePrAria": "Зберегти зміни PR",
  "gitView.pr.actions.sendCommentToAgent": "Закріпити коментар у контексті чату",
  "gitView.pr.actions.sendCommentToAgentAria": "Закріпити цей коментар у контексті чату",
  "gitView.pr.actions.sendToAgent": "Закріпити в чаті",
  "gitView.pr.actions.shareComments": "Закріпити коментарі",
  "gitView.pr.actions.shareCommentsAria": "Закріпити коментарі pull request у контексті чату",
  ...
  "gitView.pr.comments.addAll": "Закріпити все в чаті",
