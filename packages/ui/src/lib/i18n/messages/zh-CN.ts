...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.engines.permissionMode.acceptEdits': '接受编辑',
  'chat.engines.permissionMode.plan': '计划',
  'chat.engines.permissionMode.dontAsk': '不再询问',
  'chat.engines.permissionMode.aria': '权限模式：{mode}',
  'chat.engines.permissionMode.tooltip': '权限模式：{mode}',
