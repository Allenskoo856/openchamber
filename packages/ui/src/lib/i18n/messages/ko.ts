...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.engines.permissionMode.acceptEdits': '편집 수락',
  'chat.engines.permissionMode.plan': '계획',
  'chat.engines.permissionMode.dontAsk': '묻지 않음',
  'chat.engines.permissionMode.aria': '권한 모드: {mode}',
  'chat.engines.permissionMode.tooltip': '권한 모드: {mode}',
