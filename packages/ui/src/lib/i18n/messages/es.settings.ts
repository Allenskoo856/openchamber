export const settingsDict = {
  ...
  "settings.page.engines.title": "Motores",
  "settings.page.engines.description": "Elige y administra los motores de ejecución.",
...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.usage.page.state.claudeNotConfiguredDescription": "Inicia sesión con Claude Code en este host (`claude auth login`) y actualiza. Esto muestra las ventanas de uso de la suscripción de Claude, no los créditos de la API de Anthropic.",
  ...
  "settings.engines.sidebar.title": "Motores",
  "settings.engines.sidebar.subtitle": "Backends de ejecución para sesiones de chat",
  "settings.engines.sidebar.engine.opencode": "OpenCode",
  "settings.engines.sidebar.engine.claudeCode": "Claude Code",
  "settings.engines.sidebar.status.ready": "Listo",
  "settings.engines.sidebar.status.needsLogin": "Requiere inicio de sesión",
  "settings.engines.sidebar.status.missingCli": "Falta la CLI",
  "settings.engines.sidebar.status.unsupportedHost": "No disponible aquí",
  "settings.engines.sidebar.status.error": "Error",
  "settings.engines.sidebar.status.unknown": "Desconocido",
  "settings.engines.sidebar.status.loading": "Comprobando…",
  "settings.engines.page.empty.selectEngine": "Selecciona un motor en la barra lateral",
  "settings.engines.page.loadError": "No se pudo cargar el estado del motor",
  "settings.engines.opencode.title": "OpenCode",
  "settings.engines.opencode.description": "Motor predeterminado. Usa proveedores y agentes de OpenCode.",
  "settings.engines.opencode.section.about": "Acerca de",
  "settings.engines.opencode.about.body": "OpenCode ejecuta modelos a través de tus proveedores configurados. Administra las claves API en Proveedores y la configuración de agentes en Agentes.",
  "settings.engines.opencode.link.providers": "Abrir Proveedores",
  "settings.engines.opencode.link.agents": "Abrir Agentes",
  "settings.engines.claudeCode.title": "Claude Code",
  "settings.engines.claudeCode.description": "CLI nativa de Claude Code con límites de uso de la suscripción.",
  "settings.engines.claudeCode.section.status": "Estado",
  "settings.engines.claudeCode.field.status": "Estado",
  "settings.engines.claudeCode.field.version": "Versión",
  "settings.engines.claudeCode.status.version": "{version}",
  "settings.engines.claudeCode.status.versionUnknown": "Desconocida",
  "settings.engines.claudeCode.actions.redetect": "Volver a detectar",
  "settings.engines.claudeCode.actions.redetectAria": "Volver a detectar el estado de Claude Code",
  "settings.engines.claudeCode.actions.openDocs": "Abrir documentación",
  "settings.engines.claudeCode.actions.openDocsAria": "Abrir la documentación de Claude Code",
  "settings.engines.claudeCode.login.title": "Inicia sesión con Claude",
  "settings.engines.claudeCode.login.body": "Instala la CLI de Claude y ejecuta claude login en este host para que OpenChamber use tu suscripción de Claude.",
  "settings.engines.claudeCode.section.capabilities": "Capacidades",
  "settings.engines.claudeCode.capabilities.empty": "Las capacidades aparecen tras una detección correcta.",
  "settings.engines.claudeCode.capability.full": "Completa",
  "settings.engines.claudeCode.capability.partial": "Parcial",
  "settings.engines.claudeCode.capability.none": "No disponible",
  "settings.engines.claudeCode.section.warnings": "Avisos",
  "settings.engines.claudeCode.warnHandoff.label": "Avisar al cambiar de OpenCode a Claude Code",
  "settings.engines.claudeCode.warnHandoff.aria": "Avisar al cambiar de OpenCode a Claude Code",
  "settings.engines.claudeCode.warnHandoff.info": "Explica que la nueva sesión usa tu suscripción de Claude, no la facturación por API.",
  "settings.engines.claudeCode.section.apiKeys": "Claves API",
  "settings.engines.claudeCode.apiKeys.note": "Las claves API de Anthropic permanecen en Proveedores de OpenCode. Claude Code usa el inicio de sesión de suscripción de Claude en el host.",
  "settings.engines.capability.prompt": "Prompt",
  "settings.engines.capability.abort": "Abortar",
  "settings.engines.capability.resume": "Reanudar",
  "settings.engines.capability.streaming-text": "Texto en streaming",
  "settings.engines.capability.streaming-tools": "Herramientas en streaming",
  "settings.engines.capability.permissions": "Permisos",
  "settings.engines.capability.images": "Imágenes",
  "settings.engines.capability.file-attachments": "Archivos adjuntos",
  ...
  "settings.engines.capability.openchamber-tool": "Herramienta OpenChamber",
