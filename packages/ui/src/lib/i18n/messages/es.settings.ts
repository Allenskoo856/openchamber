...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.notifications.page.messengers.title": "Notificaciones de mensajería",
  "settings.notifications.page.messengers.info": "Publica las notificaciones del agente en canales de Slack o Discord mediante webhooks entrantes. Las URL de webhook se guardan en este servidor y no vuelven a mostrarse después de guardarlas.",
  "settings.notifications.page.messengers.loadFailed": "No se pudieron cargar los ajustes de mensajería.",
  "settings.notifications.page.messengers.retryAction": "Reintentar",
  "settings.notifications.page.messengers.enableLabel": "Activar notificaciones de {messenger}",
  "settings.notifications.page.messengers.enableAria": "Activar notificaciones de {messenger}",
  "settings.notifications.page.messengers.webhookLabel": "URL del webhook",
  "settings.notifications.page.messengers.webhookAria": "URL del webhook de {messenger}",
  "settings.notifications.page.messengers.webhookConfigured": "Webhook configurado.",
  "settings.notifications.page.messengers.replacePlaceholder": "Pega una nueva URL de webhook para reemplazar la guardada",
  "settings.notifications.page.messengers.saveAction": "Guardar webhook",
  "settings.notifications.page.messengers.removeAction": "Eliminar webhook",
  "settings.notifications.page.messengers.testAction": "Enviar mensaje de prueba",
  "settings.notifications.page.messengers.toast.saveFailed": "No se pudieron guardar los ajustes de mensajería",
  "settings.notifications.page.messengers.toast.invalidUrl": "Introduce una URL de webhook de {messenger} válida",
  "settings.notifications.page.messengers.toast.testSent": "Mensaje de prueba enviado a {messenger}",
  "settings.notifications.page.messengers.toast.testFailed": "No se pudo enviar el mensaje de prueba a {messenger}",
