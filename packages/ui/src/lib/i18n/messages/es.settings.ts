...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.mcp.page.actions.showTools": "Mostrar herramientas",
  "settings.mcp.page.actions.loadingTools": "Cargando herramientas...",
  "settings.mcp.page.actions.refreshTools": "Actualizar",
  "settings.mcp.page.toolsDialog.title": "Herramientas MCP",
  "settings.mcp.page.toolsDialog.description": "Herramientas que este servidor MCP anuncia actualmente.",
  "settings.mcp.page.toolsDialog.descriptionWithServer": "Herramientas que anuncia actualmente {server}.",
  "settings.mcp.page.toolsDialog.loading": "Consultando al servidor MCP su lista de herramientas…",
  "settings.mcp.page.toolsDialog.empty": "Este servidor MCP no anunció ninguna herramienta.",
  "settings.mcp.page.toolsDialog.truncated": "Se muestran las primeras {count} herramientas. Este servidor ofrece más; la lista se truncó.",
  ...
  "settings.mcp.page.toast.listToolsFailed": "No se pudieron listar las herramientas MCP",
