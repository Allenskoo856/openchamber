...
Historical evidence must not be used to certify SDK `1.18.9`, plugin commit `04b4b3da27ec05f25dcc2e8330d401f92aff2678`, plugin API/OpenCode `1.18.8`, newly built images, or current native packages.
