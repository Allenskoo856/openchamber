...
Historical evidence must not be used to certify SDK `1.18.9`, plugin commit `d8eb3cdb903d0ea3d78213c63aa938854a1c4cf2`, plugin API/OpenCode `1.18.8`, newly built images, or current native packages.
