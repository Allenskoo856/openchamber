...
Historical evidence must not be used to certify SDK `1.18.9`, plugin commit `76bbe58036f43dfe645225ed0cb3548058e306f9`, plugin API/OpenCode `1.18.8`, newly built images, or current native packages.
